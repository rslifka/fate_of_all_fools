...
var t=a(this).has("._2kz8P").length+a(this).has("._3iMN1").length>0;a(this).attr("data-fate-masterwork",t);var n=a(this).attr("id").split("-")[0];a(this).attr("data-fate-serial",n);var r=a(this).find(".AtD93").children("span").text();a(this).attr("data-fate-light",r)})})}function i(){a("[data-fate-armor-registered]").each(function(e,t){var n=a(this).attr("data-fate-serial"),r=a.map(a(this).find("svg"),function(e,t){return a(e).attr("data-icon")}),i=r.includes("ban");a(this).attr("data-fate-dimtag-junk",i);var o=r.includes("archive");a(this).attr("data-fate-dimtag-archive",o);var c="not-registered";r.includes("thumbs-up")?c="accepted":r.includes("thumbs-down")&&(c="rejected"),a(this).attr("data-fate-wishlist-status",c);var l=s.contains(n);a(this).attr("data-fate-armor-registered",l);var f=a(this).find(".AtD93").children("span").text();if(a(this).attr("data-fate-light",f),!l)return a(this).removeAttr("data-fate-comment"),a(this).removeAttr("data-fate-armor-junk"),a(this).removeAttr("data-fate-armor-pve"),void a(this).removeAttr("data-fate-armor-pvp");var d=s.get(n);a(this).attr("data-fate-comment",d.comments),a(this).attr("data-fate-armor-junk",d.pveUtility===u.NO&&d.pvpUtility===u.NO),a(this).attr("data-fate-armor-pve",d.pveUtility===u.YES),a(this).attr("data-fate-armor-pvp",d.pvpUtility===u.YES)})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("armorRollDatabase.js").armorRollDB,u=t("armorRoll.js").Utility,c=["bucket-3448274439",// Helm
...
u=e.pageX-window.pageXOffset,c=e.pageY-window.pageYOffset}),o.subscribe(n,"fate.refresh",function(){a.log("itemIdCopy.js: Registering copy on all weapons"),r()})}),require.register("logger.js",function(e,t,n){function r(e){a=e}function i(e){a&&GM_log("[FATE] "+e)}const o=t("fateBus.js");o.registerModule(n);var a;r(!1),e.setEnabled=r,e.log=i}),require.register("main.js",function(e,t,n){const r=t("fateBus.js");/*
...
var t=a(this).has("._2kz8P").length+a(this).has("._3iMN1").length>0;a(this).attr("data-fate-masterwork",t);var n=a(this).attr("id").split("-")[0];a(this).attr("data-fate-serial",n);var r=a(this).find(".AtD93").children("span").text();a(this).attr("data-fate-light",r)})})}function i(){a("[data-fate-weapon-registered]").each(function(e,t){var n=a(this).attr("data-fate-serial"),r=a.map(a(this).find("svg"),function(e,t){return a(e).attr("data-icon")}),i=r.includes("ban");a(this).attr("data-fate-dimtag-junk",i);var o=r.includes("archive");a(this).attr("data-fate-dimtag-archive",o);var c=r.includes("tag");a(this).attr("data-fate-dimtag-keep",c);var l=r.includes("bolt");a(this).attr("data-fate-dimtag-infuse",l);var f="not-registered";r.includes("thumbs-up")?f="accepted":r.includes("thumbs-down")&&(f="rejected"),a(this).attr("data-fate-wishlist-status",f);var d=s.contains(n);if(a(this).attr("data-fate-weapon-registered",d),!d)return a(this).removeAttr("data-fate-comment"),a(this).removeAttr("data-fate-weapon-junk"),a(this).removeAttr("data-fate-weapon-pve"),void a(this).removeAttr("data-fate-weapon-pvp");var p=s.get(n);a(this).attr("data-fate-comment",p.comments),a(this).attr("data-fate-weapon-junk",p.pveUtility===u.NO&&p.pvpUtility===u.NO),a(this).attr("data-fate-weapon-pve",p.pveUtility===u.YES),a(this).attr("data-fate-weapon-pvp",p.pvpUtility===u.YES)})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("weaponRollDatabase.js").weaponRollDB,u=t("weaponRollAssessment.js").Utility,c=["bucket-1498876634",// Kinetic
