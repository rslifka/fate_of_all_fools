...
var t=a(this).has("._2kz8P").length+a(this).has("._3iMN1").length>0;a(this).attr("data-fate-masterwork",t);var n=a(this).attr("id").split("-")[0];a(this).attr("data-fate-serial",n);var r=a(this).find(".AtD93").children("span").text();a(this).attr("data-fate-light",r)})})}function i(){a("[data-fate-armor-registered]").each(function(e,t){var n=a(this).attr("data-fate-serial"),r=a.map(a(this).find("span.app-icon"),function(e,t){var n=a(e).attr("class").split(" ").filter(function(e){return e.startsWith("fa-")})[0];return n.replace("fa-","")}),i=r.includes("ban");a(this).attr("data-fate-dimtag-junk",i);var o=r.includes("archive");a(this).attr("data-fate-dimtag-archive",o);var c=s.contains(n);a(this).attr("data-fate-armor-registered",c);var l=a(this).find(".AtD93").children("span").text();if(a(this).attr("data-fate-light",l),!c)return a(this).removeAttr("data-fate-comment"),a(this).removeAttr("data-fate-armor-junk"),a(this).removeAttr("data-fate-armor-pve"),void a(this).removeAttr("data-fate-armor-pvp");var f=s.get(n);a(this).attr("data-fate-comment",f.comments),a(this).attr("data-fate-armor-junk",f.pveUtility===u.NO&&f.pvpUtility===u.NO),a(this).attr("data-fate-armor-pve",f.pveUtility===u.YES),a(this).attr("data-fate-armor-pvp",f.pvpUtility===u.YES)})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("armorRollDatabase.js").armorRollDB,u=t("armorRoll.js").Utility,c=["bucket-3448274439",// Helm
