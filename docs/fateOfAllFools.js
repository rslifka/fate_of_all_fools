...
Fe.set(e,t,n)}else n=void 0;return n}function g(e,t,n,r){var i,o=1,a=20,s=r?function(){return r.cur()}:function(){return ge.css(e,t,"")},u=s(),c=n&&n[3]||(ge.cssNumber[t]?"":"px"),
...
function b(e,t){for(var n=0,r=e.length;n<r;n++)Ie.set(e[n],"globalEval",!t||Ie.get(t[n],"globalEval"))}function w(e,t,n,r,i){for(var o,a,s,u,c,l,f=t.createDocumentFragment(),d=[],p=0,h=e.length;p<h;p++)if(o=e[p],o||0===o)
// Add nodes directly
if("object"===ge.type(o))
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
ge.merge(d,o.nodeType?[o]:o);else if(Ye.test(o)){for(a=a||f.appendChild(t.createElement("div")),
// Deserialize a standard representation
s=(ze.exec(o)||["",""])[1].toLowerCase(),u=Ke[s]||Ke._default,a.innerHTML=u[1]+ge.htmlPrefilter(o)+u[2],
...
function C(){try{return ne.activeElement}catch(e){}}function T(e,t,n,r,i,o){var a,s;
// Types can be a map of types/handlers
if("object"==typeof t){
// ( types-Object, selector, data )
"string"!=typeof n&&(
// ( types-Object, data )
r=r||n,n=void 0);for(s in t)T(e,s,n,r,t[s],o);return e}if(null==r&&null==i?(
// ( types, fn )
...
function S(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function D(e){var t=it.exec(e.type);return t?e.type=t[1]:e.removeAttribute("type"),e}function E(e,t){var n,r,i,o,a,s,u,c;if(1===t.nodeType){
// 1. Copy private data: events, handlers, etc.
if(Ie.hasData(e)&&(o=Ie.access(e),a=Ie.set(t,o),c=o.events)){delete a.handle,a.events={};for(i in c)for(n=0,r=c[i].length;n<r;n++)ge.event.add(t,i,c[i][n])}
// 2. Copy user data
...
if(g||d>1&&"string"==typeof h&&!pe.checkClone&&rt.test(h))return e.each(function(n){var o=e.eq(n);g&&(t[0]=h.call(this,n,o.html())),_(o,t,r,i)});if(d&&(o=w(t,e[0].ownerDocument,!1,e,i),a=o.firstChild,1===o.childNodes.length&&(o=a),a||i)){
// Use the original fragment for the last item
// instead of the first because it can end up
// being emptied incorrectly in certain situations (#8070).
for(s=ge.map(y(o,"script"),S),u=s.length;f<d;f++)c=o,f!==p&&(c=ge.clone(c,!0,!0),
...
// Reenable scripts
ge.map(s,D),f=0;f<u;f++)c=s[f],Xe.test(c.type||"")&&!Ie.access(c,"globalEval")&&ge.contains(l,c)&&(c.src?
// Optional AJAX dependency, but won't run scripts if not present
ge._evalUrl&&ge._evalUrl(c.src):n(c.textContent.replace(ot,""),l))}return e}function M(e,t,n){for(var r,i=t?ge.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||ge.cleanData(y(r)),r.parentNode&&(n&&ge.contains(r.ownerDocument,r)&&b(y(r,"script")),r.parentNode.removeChild(r));return e}function q(e,t,n){var r,i,o,a,
// Support: Firefox 51+
...
function L(e){var t=ge.cssProps[e];return t||(t=ge.cssProps[e]=A(e)||e),t}function I(e,t,n){
// Any relative (+/-) values have already been
// normalized at this point
var r=Be.exec(t);
// Guard against undefined "subtract", e.g., when used as in cssHooks
return r?Math.max(0,r[2]-(n||0))+(r[3]||"px"):t}function F(e,t,n,r,i){var o,a=0;for(
// If we already have the right measurement, avoid augmentation
o=n===(r?"border":"content")?4:"width"===t?1:0;o<4;o+=2)
// Both box models exclude margin, so add it if we want it
"margin"===n&&(a+=ge.css(e,n+Ge[o],!0,i)),r?(
// border-box includes padding, so remove it if we want content
"content"===n&&(a-=ge.css(e,"padding"+Ge[o],!0,i)),
// At this point, extra isn't border nor margin, so remove border
"margin"!==n&&(a-=ge.css(e,"border"+Ge[o]+"Width",!0,i))):(
// At this point, extra isn't content, so add padding
a+=ge.css(e,"padding"+Ge[o],!0,i),
// At this point, extra isn't content nor padding, so add border
"padding"!==n&&(a+=ge.css(e,"border"+Ge[o]+"Width",!0,i)));return a}function H(e,t,n){
...
t=t?1:0;r<4;r+=2-t)n=Ge[r],i["margin"+n]=i["padding"+n]=e;return t&&(i.opacity=i.width=e),i}function W(e,t,n){for(var r,i=(U.tweeners[t]||[]).concat(U.tweeners["*"]),o=0,a=i.length;o<a;o++)if(r=i[o].call(n,t,e))
...
// Per-property setup
u=W(g?m[r]:0,r,d),r in m||(m[r]=u.start,g&&(u.end=u.start,u.start=0))}}function V(e,t){var n,r,i,o,a;
...
ge.each(t,function(t,i){n||Et.test(e)?
...
return function(t,n){"string"!=typeof t&&(n=t,t="*");var r,i=0,o=t.toLowerCase().match(Me)||[];if(ge.isFunction(n))
// For each dataType in the dataTypeExpression
for(;r=o[i++];)
// Prepend if requested
"+"===r[0]?(r=r.slice(1)||"*",(e[r]=e[r]||[]).unshift(n)):(e[r]=e[r]||[]).push(n)}}
// Base inspection function for prefilters and transports
function J(e,t,n,r){function i(s){var u;return o[s]=!0,ge.each(e[s]||[],function(e,s){var c=s(t,n,r);return"string"!=typeof c||a||o[c]?a?!(u=c):void 0:(t.dataTypes.unshift(c),i(c),!1)}),u}var o={},a=e===Rt;return i(t.dataTypes[0])||!o["*"]&&i("*")}
...
if(!r&&((t?t.ownerDocument||t:B)!==O&&q(t),t=t||O,L)){
...
// TODO: identify versions
// getElementById can match elements by name instead of ID
if(d&&(a=d.getElementById(i))&&P(t,a)&&a.id===i)return n.push(a),n}else{if(u[2])return Q.apply(n,t.getElementsByTagName(e)),n;if((i=u[3])&&j.getElementsByClassName&&t.getElementsByClassName)return Q.apply(n,t.getElementsByClassName(i)),n}
...
if(u){for(;t=t[r];)if((1===t.nodeType||a)&&e(t,n,u))return!0}else for(;t=t[r];)if(1===t.nodeType||a)if(f=t[R]||(t[R]={}),
// Support: IE <9 only
...
l=b.length;l--;)(f=b[l])&&(c=o?ee(r,f):d[l])>-1&&(r[c]=!(a[c]=f))}}else b=v(b===a?b.splice(h,b.length):b),o?o(null,a,b,u):Q.apply(a,b)})}function b(e){for(var t,n,r,i=e.length,o=C.relative[e[0].type],a=o||C.relative[" "],s=o?1:0,
// The foundational matcher ensures that elements are reachable from top-level context(s)
u=h(function(e){return e===t},a,!0),c=h(function(e){return ee(t,e)>-1},a,!0),l=[function(e,n,r){var i=!o&&(r||n!==N)||((t=n).nodeType?u(e,n,r):c(e,n,r));
...
return y(s>1&&g(l),s>1&&p(e.slice(0,s-1).concat({value:" "===e[s-2].type?"*":""})).replace(se,"$1"),n,s<r&&b(e.slice(s,r)),r<i&&b(e=e.slice(r)),r<i&&p(e))}l.push(n)}return g(l)}function w(e,n){var i=n.length>0,o=e.length>0,a=function(r,a,s,u,c){var l,f,d,p=0,h="0",g=r&&[],m=[],y=N,
...
for(c&&(N=a===O||a||c);h!==x&&null!=(l=b[h]);h++){if(o&&l){for(f=0,a||l.ownerDocument===O||(q(l),s=!L);d=e[f++];)if(d(l,a||O,s)){u.push(l);break}c&&(G=w)}
...
return c&&(G=w,N=y),g};return i?r(a):a}var x,j,C,T,k,S,D,E,N,_,M,
// Local document vars
q,O,A,L,I,F,H,P,
...
return r!==O&&9===r.nodeType&&r.documentElement?(O=r,A=O.documentElement,L=!k(O),B!==O&&(n=O.defaultView)&&n.top!==n&&(n.addEventListener?n.addEventListener("unload",Ce,!1):n.attachEvent&&n.attachEvent("onunload",Ce)),j.attributes=i(function(e){return e.className="i",!e.getAttribute("className")}),j.getElementsByTagName=i(function(e){return e.appendChild(O.createComment("")),!e.getElementsByTagName("*").length}),j.getElementsByClassName=me.test(O.getElementsByClassName),j.getById=i(function(e){return A.appendChild(e).id=R,!O.getElementsByName||!O.getElementsByName(R).length}),j.getById?(C.filter.ID=function(e){var t=e.replace(be,we);return function(e){return e.getAttribute("id")===t}},C.find.ID=function(e,t){if("undefined"!=typeof t.getElementById&&L){var n=t.getElementById(e);return n?[n]:[]}}):(C.filter.ID=function(e){var t=e.replace(be,we);return function(e){var n="undefined"!=typeof e.getAttributeNode&&e.getAttributeNode("id");return n&&n.value===t}},C.find.ID=function(e,t){if("undefined"!=typeof t.getElementById&&L){var n,r,i,o=t.getElementById(e);if(o){if(
// Verify the id attribute
n=o.getAttributeNode("id"),n&&n.value===e)return[o];for(
// Fall back on getElementsByName
i=t.getElementsByName(e),r=0;o=i[r++];)if(n=o.getAttributeNode("id"),n&&n.value===e)return[o]}return[]}}),C.find.TAG=j.getElementsByTagName?function(e,t){return"undefined"!=typeof t.getElementsByTagName?t.getElementsByTagName(e):j.qsa?t.querySelectorAll(e):void 0}:function(e,t){var n,r=[],i=0,
// By happy coincidence, a (broken) gEBTN appears on DocumentFragment nodes too
o=t.getElementsByTagName(e);
// Filter out possible comments
if("*"===e){for(;n=o[i++];)1===n.nodeType&&r.push(n);return r}return o},C.find.CLASS=j.getElementsByClassName&&function(e,t){if("undefined"!=typeof t.getElementsByClassName&&L)return t.getElementsByClassName(e)},F=[],I=[],(j.qsa=me.test(O.querySelectorAll))&&(i(function(e){
...
A.appendChild(e).disabled=!0,2!==e.querySelectorAll(":disabled").length&&I.push(":enabled",":disabled"),
// Opera 10-11 does not throw on post-comma invalid pseudos
e.querySelectorAll("*,:x"),I.push(",.*:")})),(j.matchesSelector=me.test(H=A.matches||A.webkitMatchesSelector||A.mozMatchesSelector||A.oMatchesSelector||A.msMatchesSelector))&&i(function(e){
// Check to see if it's possible to do matchesSelector
// on a disconnected node (IE 9)
j.disconnectedMatch=H.call(e,"*"),
// This should fail with an exception
// Gecko does not error, returns false instead
H.call(e,"[s!='']:x"),F.push("!=",oe)}),I=I.length&&new RegExp(I.join("|")),F=F.length&&new RegExp(F.join("|")),t=me.test(A.compareDocumentPosition),P=t||me.test(A.contains)?function(e,t){var n=9===e.nodeType?e.documentElement:e,r=t&&t.parentNode;return e===r||!(!r||1!==r.nodeType||!(n.contains?n.contains(r):e.compareDocumentPosition&&16&e.compareDocumentPosition(r)))}:function(e,t){if(t)for(;t=t.parentNode;)if(t===e)return!0;return!1},z=t?function(e,t){
...
return n?n:(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1,1&n||!j.sortDetached&&t.compareDocumentPosition(e)===n?e===O||e.ownerDocument===B&&P(B,e)?-1:t===O||t.ownerDocument===B&&P(B,t)?1:_?ee(_,e)-ee(_,t):0:4&n?-1:1)}:function(e,t){
// Exit early if the nodes are identical
if(e===t)return M=!0,0;var n,r=0,i=e.parentNode,o=t.parentNode,s=[e],u=[t];
// Parentless nodes are either documents or disconnected
if(!i||!o)return e===O?-1:t===O?1:i?-1:o?1:_?ee(_,e)-ee(_,t):0;if(i===o)return a(e,t);for(
...
return o[R]?o(n):o.length>1?(i=[e,e,"",n],C.setFilters.hasOwnProperty(e.toLowerCase())?r(function(e,t){for(var r,i=o(e,n),a=i.length;a--;)r=ee(e,i[a]),e[r]=!(t[r]=i[a])}):function(e){return o(e,0,i)}):o}},pseudos:{
// Potentially complex pseudos
not:r(function(e){
// Trim the selector passed to compile
// to avoid treating leading and trailing
// spaces as combinators
var t=[],n=[],i=D(e.replace(se,"$1"));return i[R]?r(function(e,t,n,r){
// Match elements unmatched by `matcher`
for(var o,a=i(e,null,r,[]),s=e.length;s--;)(o=a[s])&&(e[s]=!(t[s]=o))}):function(e,r,o){
// Don't keep the element (issue #299)
return t[0]=e,i(t,null,o,n),t[0]=null,!n.pop()}}),has:r(function(e){return function(n){return t(e,n).length>0}}),contains:r(function(e){return e=e.replace(be,we),function(t){return(t.textContent||t.innerText||T(t)).indexOf(e)>-1}}),
...
// Miscellaneous
target:function(t){var n=e.location&&e.location.hash;return n&&n.slice(1)===t.id},root:function(e){return e===A},focus:function(e){return e===O.activeElement&&(!O.hasFocus||O.hasFocus())&&!!(e.type||e.href||~e.tabIndex)},
// Boolean properties
...
return d.prototype=C.filters=C.pseudos,C.setFilters=new d,S=t.tokenize=function(e,n){var r,i,o,a,s,u,c,l=V[e+" "];if(l)return n?0:l.slice(0);for(s=e,u=[],c=C.preFilter;s;){
// Comma and first run
r&&!(i=ue.exec(s))||(i&&(
...
// Filters
for(a in C.filter)!(i=pe[a].exec(s))||c[a]&&!(i=c[a](i))||(r=i.shift(),o.push({value:r,type:a,matches:i}),s=s.slice(r.length));if(!r)break}
// Return the length of the invalid excess
// if we're just parsing
// Otherwise, throw an error or return tokens
// Cache the tokens
return n?s.length:s?t.error(e):V(e,u).slice(0)},D=t.compile=function(e,t){var n,r=[],i=[],o=U[e+" "];if(!o){for(
// Generate a function of recursive functions that can be used to check each element
t||(t=S(e)),n=t.length;n--;)o=b(t[n]),o[R]?r.push(o):i.push(o);
// Cache the compiled function
o=U(e,w(i,r)),
// Save selector and tokenization
o.selector=e}return o},E=t.select=function(e,t,n,r){var i,o,a,s,u,c="function"==typeof e&&e,l=!r&&S(e=c.selector||e);
// Try to minimize operations if there is only one selector in the list and no seed
// (the latter of which guarantees us context)
if(n=n||[],1===l.length){if(
// Reduce context if the leading compound selector is an ID
o=l[0]=l[0].slice(0),o.length>2&&"ID"===(a=o[0]).type&&9===t.nodeType&&L&&C.relative[o[1].type]){if(t=(C.find.ID(a.matches[0].replace(be,we),t)||[])[0],!t)return n;c&&(t=t.parentNode),e=e.slice(o.shift().value.length)}for(
// Fetch a seed set for right-to-left matching
i=pe.needsContext.test(e)?0:o.length;i--&&(a=o[i],!C.relative[s=a.type]);)if((u=C.find[s])&&(r=u(a.matches[0].replace(be,we),ye.test(o[0].type)&&f(t.parentNode)||t))){if(
// If seed is empty or no tokens remain, we can return early
o.splice(i,1),e=r.length&&p(o),!e)return Q.apply(n,r),n;break}}
// Compile and execute a filtering function if one is not provided
// Provide `match` to avoid retokenization if we modified the selector above
return(c||D(e,l))(r,t,!L,n,!t||ye.test(e)&&f(t.parentNode)||t),n},j.sortStable=R.split("").sort(z).join("")===R,j.detectDuplicates=!!M,q(),j.sortDetached=i(function(e){
...
De=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,Ee=ge.fn.init=function(e,t,n){var r,i;
...
r="<"===e[0]&&">"===e[e.length-1]&&e.length>=3?[null,e,null]:De.exec(e),!r||!r[1]&&t)return!t||t.jquery?(t||n).find(e):this.constructor(t).find(e);
// HANDLE: $(html) -> $(array)
if(r[1]){
// HANDLE: $(html, props)
...
_e={children:!0,contents:!0,next:!0,prev:!0};ge.fn.extend({has:function(e){var t=ge(e,this),n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(ge.contains(this,t[e]))return!0})},closest:function(e,t){var n,r=0,i=this.length,o=[],a="string"!=typeof e&&ge(e);
...
var Ae=function(e,t,n,r,i,o,a){var s=0,u=e.length,c=null==n;
// Sets many values
if("object"===ge.type(n)){i=!0;for(s in n)Ae(e,t,s,n[s],!0,o,a)}else if(void 0!==r&&(i=!0,ge.isFunction(r)||(a=!0),c&&(
...
_data:function(e,t,n){return Ie.access(e,t,n)},_removeData:function(e,t){Ie.remove(e,t)}}),ge.fn.extend({data:function(e,t){var n,r,i,o=this[0],a=o&&o.attributes;
// Gets all values
if(void 0===e){if(this.length&&(i=Fe.get(o),1===o.nodeType&&!Ie.get(o,"hasDataAttrs"))){for(n=a.length;n--;)
// Support: IE 11 only
// The attrs elements can be null (#14894)
a[n]&&(r=a[n].name,0===r.indexOf("data-")&&(r=ge.camelCase(r.slice(5)),h(o,r,i[r])));Ie.set(o,"hasDataAttrs",!0)}return i}
// Sets multiple values
// Sets multiple values
return"object"==typeof e?this.each(function(){Fe.set(this,e)}):Ae(this,function(t){var n;
...
n=Fe.get(o,e),void 0!==n)return n;if(
...
return t=(t||"fx")+"queue",r=Ie.get(e,t),n&&(!r||Array.isArray(n)?r=Ie.access(e,t,ge.makeArray(n)):r.push(n)),r||[]},dequeue:function(e,t){t=t||"fx";var n=ge.queue(e,t),r=n.length,i=n.shift(),o=ge._queueHooks(e,t),a=function(){ge.dequeue(e,t)};
...
promise:function(e,t){var n,r=1,i=ge.Deferred(),o=this,a=this.length,s=function(){--r||i.resolveWith(o,[o])};for("string"!=typeof e&&(t=e,e=void 0),e=e||"fx";a--;)n=Ie.get(o[a],e+"queueHooks"),n&&n.empty&&(r++,n.empty.add(s));return s(),i.promise(t)}});var Re=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Be=new RegExp("^(?:([+-])=|)("+Re+")([a-z%]*)$","i"),Ge=["Top","Right","Bottom","Left"],We=function(e,t){
...
for(o in t)e.style[o]=a[o];return i},Ve={};ge.fn.extend({show:function(){return v(this,!0)},hide:function(){return v(this)},toggle:function(e){return"boolean"==typeof e?e?this.show():this.hide():this.each(function(){We(this)?ge(this).show():ge(this).hide()})}});var Ue=/^(?:checkbox|radio)$/i,ze=/<([a-z][^\/\0>\x20\t\r\n\f]+)/i,Xe=/^$|\/(?:java|ecma)script/i,Ke={
// Support: IE <=9 only
...
var t,n,r,i,o,a,s=ge.event.fix(e),u=new Array(arguments.length),c=(Ie.get(this,"events")||{})[s.type]||[],l=ge.event.special[s.type]||{};for(
...
return i&&(i===r||ge.contains(r,i))||(e.type=o.origType,n=o.handler.apply(this,arguments),e.type=t),n}}}),ge.fn.extend({on:function(e,t,n,r){return T(this,e,t,n,r)},one:function(e,t,n,r){return T(this,e,t,n,r,1)},off:function(e,t,n){var r,i;if(e&&e.preventDefault&&e.handleObj)
...
a=y(s),o=y(e),r=0,i=o.length;r<i;r++)N(o[r],a[r]);
// Copy the events from the original to the clone
if(t)if(n)for(o=o||y(e),a=a||y(s),r=0,i=o.length;r<i;r++)E(o[r],a[r]);else E(e,s);
...
// Support: Chrome <=35 - 45+
// Assign undefined instead of using delete, see Data#remove
n[Fe.expando]=void 0)}}}),ge.fn.extend({detach:function(e){return M(this,e,!0)},remove:function(e){return M(this,e)},text:function(e){return Ae(this,function(e){return void 0===e?ge.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=e)})},null,e,arguments.length)},append:function(){return _(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=k(this,e);t.appendChild(e)}})},prepend:function(){return _(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=k(this,e);t.insertBefore(e,t.firstChild)}})},before:function(){return _(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this)})},after:function(){return _(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this.nextSibling)})},empty:function(){for(var e,t=0;null!=(e=this[t]);t++)1===e.nodeType&&(
// Prevent memory leaks
ge.cleanData(y(e,!1)),
// Remove any remaining nodes
e.textContent="");return this},clone:function(e,t){return e=null!=e&&e,t=null==t?e:t,this.map(function(){return ge.clone(this,e,t)})},html:function(e){return Ae(this,function(e){var t=this[0]||{},n=0,r=this.length;if(void 0===e&&1===t.nodeType)return t.innerHTML;
...
ae.apply(r,n.get());return this.pushStack(r)}});var at=/^margin/,st=new RegExp("^("+Re+")(?!px)[a-z%]+$","i"),ut=function(t){
...
if(s){s.style.cssText="box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%",s.innerHTML="",Je.appendChild(a);var t=e.getComputedStyle(s);n="1%"!==t.top,
// Support: Android 4.0 - 4.3 only, Firefox <=3 - 44
o="2px"===t.marginLeft,r="4px"===t.width,
// Support: Android 4.0 - 4.3 only
// Some styles come back with percentage values, even though they shouldn't
s.style.marginRight="50%",i="4px"===t.marginRight,Je.removeChild(a),
...
// Make numeric if forced or a qualifier was provided and val looks numeric
return u||(t=L(s)),a=ge.cssHooks[t]||ge.cssHooks[s],a&&"get"in a&&(i=a.get(e,!0,n)),void 0===i&&(i=q(e,t,r)),"normal"===i&&t in dt&&(i=dt[t]),""===n||n?(o=parseFloat(i),n===!0||isFinite(o)?o||0:i):i}}),ge.each(["height","width"],function(e,t){ge.cssHooks[t]={get:function(e,n,r){if(n)
...
return!ct.test(ge.css(e,"display"))||e.getClientRects().length&&e.getBoundingClientRect().width?H(e,t,r):$e(e,ft,function(){return H(e,t,r)})},set:function(e,n,r){var i,o=r&&ut(e),a=r&&F(e,t,r,"border-box"===ge.css(e,"boxSizing",!1,o),o);
// Convert to pixels if value adjustment is needed
return a&&(i=Be.exec(n))&&"px"!==(i[3]||"px")&&(e.style[t]=n,n=ge.css(e,t)),I(e,n,a)}}}),ge.cssHooks.marginLeft=O(pe.reliableMarginLeft,function(e,t){if(t)return(parseFloat(q(e,"marginLeft"))||e.getBoundingClientRect().left-$e(e,{marginLeft:0},function(){return e.getBoundingClientRect().left}))+"px"}),
// These hooks are used by animate to expand properties
ge.each({margin:"",padding:"",border:"Width"},function(e,t){ge.cssHooks[e+t]={expand:function(n){for(var r=0,i={},
// Assumes a single number if not a string
o="string"==typeof n?n.split(" "):[n];r<4;r++)i[e+Ge[r]+t]=o[r]||o[r-2]||o[0];return i}},at.test(e)||(ge.cssHooks[e+t].set=I)}),ge.fn.extend({css:function(e,t){return Ae(this,function(e,t,n){var r,i,o={},a=0;if(Array.isArray(t)){for(r=ut(e),i=t.length;a<i;a++)o[t[a]]=ge.css(e,t[a],!1,r);return o}return void 0!==n?ge.style(e,t,n):ge.css(e,t)},e,t,arguments.length>1)}}),ge.Tween=P,P.prototype={constructor:P,init:function(e,t,n,r,i,o){this.elem=e,this.prop=n,this.easing=i||ge.easing._default,this.options=t,this.start=this.now=this.cur(),this.end=r,this.unit=o||(ge.cssNumber[n]?"":"px")},cur:function(){var e=P.propHooks[this.prop];return e&&e.get?e.get(this):P.propHooks._default.get(this)},run:function(e){var t,n=P.propHooks[this.prop];return this.options.duration?this.pos=t=ge.easing[this.easing](e,this.options.duration*e,0,1,this.options.duration):this.pos=t=e,this.now=(this.end-this.start)*t+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),n&&n.set?n.set(this):P.propHooks._default.set(this),this}},P.prototype.init.prototype=P.prototype,P.propHooks={_default:{get:function(e){var t;
...
return this.filter(We).css("opacity",0).show().end().animate({opacity:t},e,n,r)},animate:function(e,t,n,r){var i=ge.isEmptyObject(e),o=ge.speed(t,n,r),a=function(){
// Operate on a copy of prop so per-property easing won't be lost
var t=U(this,ge.extend({},e),o);
// Empty animations, or finishing resolves immediately
(i||Ie.get(this,"finish"))&&t.stop(!0)};return a.finish=a,i||o.queue===!1?this.each(a):this.queue(o.queue,a)},stop:function(e,t,n){var r=function(e){var t=e.stop;delete e.stop,t(n)};return"string"!=typeof e&&(n=t,t=e,e=void 0),t&&e!==!1&&this.queue(e||"fx",[]),this.each(function(){var t=!0,i=null!=e&&e+"queueHooks",o=ge.timers,a=Ie.get(this);if(i)a[i]&&a[i].stop&&r(a[i]);else for(i in a)a[i]&&a[i].stop&&yt.test(i)&&r(a[i]);for(i=o.length;i--;)o[i].elem!==this||null!=e&&o[i].queue!==e||(o[i].anim.stop(n),t=!1,o.splice(i,1));
// Start the next in the queue if the last step wasn't forced.
// Timers currently will call their complete callbacks, which
// will dequeue but only if they were gotoEnd.
!t&&n||ge.dequeue(this,e)})},finish:function(e){return e!==!1&&(e=e||"fx"),this.each(function(){var t,n=Ie.get(this),r=n[e+"queue"],i=n[e+"queueHooks"],o=ge.timers,a=r?r.length:0;
...
e=ne.createElement("input"),e.value="t",e.type="radio",pe.radioValue="t"===e.value}();var bt,wt=ge.expr.attrHandle;ge.fn.extend({attr:function(e,t){return Ae(this,ge.attr,e,t,arguments.length>1)},removeAttr:function(e){return this.each(function(){ge.removeAttr(this,e)})}}),ge.extend({attr:function(e,t,n){var r,i,o=e.nodeType;
...
var t=e.parentNode;t&&(t.selectedIndex,t.parentNode&&t.parentNode.selectedIndex)}}),ge.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){ge.propFix[this.toLowerCase()]=this}),ge.fn.extend({addClass:function(e){var t,n,r,i,o,a,s,u=0;if(ge.isFunction(e))return this.each(function(t){ge(this).addClass(e.call(this,t,X(this)))});if("string"==typeof e&&e)for(t=e.match(Me)||[];n=this[u++];)if(i=X(n),r=1===n.nodeType&&" "+z(i)+" "){for(a=0;o=t[a++];)r.indexOf(" "+o+" ")<0&&(r+=o+" ");
// Only assign if different to avoid unneeded rendering.
s=z(r),i!==s&&n.setAttribute("class",s)}return this},removeClass:function(e){var t,n,r,i,o,a,s,u=0;if(ge.isFunction(e))return this.each(function(t){ge(this).removeClass(e.call(this,t,X(this)))});if(!arguments.length)return this.attr("class","");if("string"==typeof e&&e)for(t=e.match(Me)||[];n=this[u++];)if(i=X(n),
...
r=0,i=ge(this),o=e.match(Me)||[];t=o[r++];)
...
var Tt=/^(?:focusinfocus|focusoutblur)$/;ge.extend(ge.event,{trigger:function(t,n,r,i){var o,a,s,u,c,l,f,d=[r||ne],p=le.call(t,"type")?t.type:t,h=le.call(t,"namespace")?t.namespace.split("."):[];
// Don't do events on text and comment nodes
if(a=s=r=r||ne,3!==r.nodeType&&8!==r.nodeType&&!Tt.test(p+ge.event.triggered)&&(p.indexOf(".")>-1&&(
...
if(!i&&!f.noBubble&&!ge.isWindow(r)){for(u=f.delegateType||p,Tt.test(u+p)||(a=a.parentNode);a;a=a.parentNode)d.push(a),s=a;
...
try{n=(new e.DOMParser).parseFromString(t,"text/xml")}catch(r){n=void 0}return n&&!n.getElementsByTagName("parsererror").length||ge.error("Invalid XML: "+t),n};var Et=/\[\]$/,Nt=/\r?\n/g,_t=/^(?:submit|button|image|reset|file)$/i,Mt=/^(?:input|select|textarea|keygen)/i;
...
h.ifModified&&(x=C.getResponseHeader("Last-Modified"),x&&(ge.lastModified[o]=x),x=C.getResponseHeader("etag"),x&&(ge.etag[o]=x)),
// if no content
...
h.cache===!1&&(o=o.replace(At,"$1"),p=(Dt.test(o)?"&":"?")+"_="+St++ +p),
...
s.status,s.statusText):o(Wt[s.status]||s.status,s.statusText,
// Support: IE <=9 only
...
return i=t.jsonpCallback=ge.isFunction(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,s?t[s]=t[s].replace(Ut,"$1"+i):t.jsonp!==!1&&(t.url+=(Dt.test(t.url)?"&":"?")+t.jsonp+"="+i),t.converters["script json"]=function(){return a||ge.error(i+" was not called"),a[0]},t.dataTypes[0]="json",o=e[i],e[i]=function(){a=arguments},r.always(function(){
...
// Single tag
return t||(pe.createHTMLDocument?(t=ne.implementation.createHTMLDocument(""),r=t.createElement("base"),r.href=ne.location.href,t.head.appendChild(r)):t=ne),i=Te.exec(e),o=!n&&[],i?[t.createElement(i[1])]:(i=w([e],t,o),o&&o.length&&ge(o).remove(),ge.merge([],i.childNodes))},/**
...
ge.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(e,t){var n="pageYOffset"===t;ge.fn[e]=function(r){return Ae(this,function(e,r,i){
...
ge.fn[r]=function(i,o){var a=arguments.length&&(n||"boolean"!=typeof i),s=n||(i===!0||o===!0?"margin":"border");return Ae(this,function(t,n,i){var o;
...
break}if(u)for(i in r)r.hasOwnProperty(i)&&r[i]===t&&(delete r[i],l=!0)}return l}})}()}),require.register("armorDecorator.js",function(e,t,n){function r(){c("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").not("[data-fate-armor-name]").each(function(e,t){c(this).attr("data-fate-armor-name",c(this).attr("title").split("\n")[0])})}function i(){c("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").not("[data-fate-base-light]").each(function(e,t){var n=parseInt(c(this).children(".item-stat").text().match(/(\d+)/)),r="true"===c(this).attr("data-fate-is-modded")?n-5:n;c(this).attr("data-fate-base-light",r)})}function o(){c("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").each(function(e,t){c(this).attr("data-fate-is-modded",c(this).children(".item-img.complete").length>0)})}function a(){c("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").not("[data-fate-serial]").each(function(e,t){c(this).attr("data-fate-serial",c(this).attr("id").split("-")[0])})}function s(){c("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").each(function(e,t){var n=c(this).children(".item-img.masterwork").length>0;c(this).attr("data-fate-masterwork",n)})}const u=t("fateBus.js");u.registerModule(n);var c=t("jquery");u.subscribe(n,"fate.refresh",function(){r(),o(),i(),a(),s()})}),require.register("beautification.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n),r.subscribe(n,"fate.init",function(){GM_addStyle(GM_getResourceText("fateOfAllFoolsCSS"))})}),require.register("commentDecorator.js",function(e,t,n){function r(){a.log("commentDecorator.js: Updating weapon tooltips"),o("[data-fate-weapon-registered=true]").each(function(e,t){var n=o(this).attr("data-fate-weapon-name"),r=o(this).attr("data-fate-weapon-type"),i=o(this).attr("data-fate-comment");o(this).attr("title",n+" // "+r+"\n"+i)})}const i=t("fateBus.js");i.registerModule(n);var o=t("jquery"),a=t("logger");i.subscribe(n,"fate.refresh",r)}),require.register("configuration.js",function(e,t,n){function r(){s.log("configuration.js: Initializing"),GM_config.init({id:"FateConfig",fields:{weaponDataTSV:{label:"Weapon Data Tab-Separated Values",type:"text","default":"https://docs.google.com/spreadsheets/d/e/2PACX-1vQ06pCDSdvu2nQzgHMXl22ci-6pO9rTTmvZmlKXaiBrIHVhl1X1awIaHEOagZcs4ME4X9ZMEghBP9NE/pub?gid=2031623180&single=true&output=tsv"},rollDataTSV:{label:"Roll Data Tab-Separated Values",type:"text","default":"https://docs.google.com/spreadsheets/d/e/2PACX-1vQ06pCDSdvu2nQzgHMXl22ci-6pO9rTTmvZmlKXaiBrIHVhl1X1awIaHEOagZcs4ME4X9ZMEghBP9NE/pub?gid=1131147082&single=true&output=tsv"},shaderDataTSV:{label:"Shader Data Tab-Separated Values",type:"text","default":"https://docs.google.com/spreadsheets/d/e/2PACX-1vQ06pCDSdvu2nQzgHMXl22ci-6pO9rTTmvZmlKXaiBrIHVhl1X1awIaHEOagZcs4ME4X9ZMEghBP9NE/pub?gid=1194152043&single=true&output=tsv"}},events:{save:function(){o.subscribe(n,"fate.refresh",r)}}}),o.publish(n,"fate.configurationLoaded",{weaponDataTSV:GM_config.get("weaponDataTSV"),rollDataTSV:GM_config.get("rollDataTSV"),shaderDataTSV:GM_config.get("shaderDataTSV")})}function i(){a(".fate-config").length>0||(a(".header-links").prepend("<a class='link fate-config'>FATE Config</a>"),a(".fate-config").on("click",function(){GM_config.open()}))}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("logger");o.subscribe(n,"fate.init",r),o.subscribe(n,"fate.refresh",i)}),require.register("dupeIndicator.js",function(e,t,n){function r(){f("[data-fate-weapon-name]").not("[data-fate-weapon-dupe]").each(function(e,t){f(this).attr("data-fate-weapon-dupe",!1),f(this).append(f("<div>",{"class":"fate-glyph fate-dupe fate-middling fglyph-knives"}))})}function i(){var e=new Map;return f("[data-fate-weapon-name]").each(function(t,n){var r=f(this).attr("data-fate-weapon-name"),i={name:r,domElement:this};e.has(r)?e.set(r,e.get(r).concat(i)):e.set(r,[i])}),e}function o(e){var t=!0,n=!1,r=void 0;try{for(var i,o=e[Symbol.iterator]();!(t=(i=o.next()).done);t=!0){var a=l(i.value,2),s=(a[0],a[1]);1!==s.length?s.forEach(function(e){"true"!==f(e.domElement).attr("data-fate-weapon-dupe")&&f(e.domElement).attr("data-fate-weapon-dupe",!0)}):"true"===f(s[0].domElement).attr("data-fate-weapon-dupe")&&f(s[0].domElement).attr("data-fate-weapon-dupe",!1)}}catch(u){n=!0,r=u}finally{try{!t&&o["return"]&&o["return"]()}finally{if(n)throw r}}}function a(){var e=f(this).parent().attr("data-fate-weapon-name");f("[data-fate-weapon-name]").not('[data-fate-weapon-name="'+e+'"]').addClass("fate-search-hidden")}function s(){f(".fate-search-hidden").removeClass("fate-search-hidden")}function u(){f('[data-fate-weapon-dupe="true"] > .fate-dupe').on("mouseenter.dupe",a),f('[data-fate-weapon-dupe="true"] > .fate-dupe').on("mouseleave.dupe",s)}const c=t("fateBus.js");c.registerModule(n);var l=function(){function e(e,t){var n=[],r=!0,i=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(r=(a=s.next()).done)&&(n.push(a.value),!t||n.length!==t);r=!0);}catch(u){i=!0,o=u}finally{try{!r&&s["return"]&&s["return"]()}finally{if(i)throw o}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),f=t("jquery"),d=t("logger.js");c.subscribe(n,"fate.refresh",function(){d.log("dupeIndicator.js: Calculating duplicates"),r(),o(i()),u(),c.publish(n,"fate.dupesCalculated")}),/*
  ...
  events.
*/
c.subscribe(n,"fate.test.mouseenter.dupe",function(){f('[data-fate-weapon-dupe="true"] > .fate-dupe').each(a)}),c.subscribe(n,"fate.test.mouseleave.dupe",function(){f('[data-fate-weapon-dupe="true"] > .fate-dupe').each(s)})}),require.register("fateBus.js",function(e,t,n){"use strict";function r(e){p.set(e.id,!1)}function i(){p.clear()}function o(e){return p.get(e.id)}function a(e,t,n){if(!p.has(e.id))throw new Error("fateBus.js#publish: Module ["+e.id+"] is not defined");o(e)||d.publishSync(t,n)}function s(e,t,n){if(!p.has(e.id))throw new Error("fateBus.js#subscribe: Module ["+e.id+"] is not defined");d.subscribe(t,function(t,r){p.has(e.id)&&(o(e)||n(t,r))})}function u(e){p.set(e,!0)}function c(){var e=Array.from(p.keys());e.forEach(function(e){u(e)})}function l(e){p.set(e,!1)}function f(e){d.unsubscribe(e)}var d=t("pubsub-js"),p=new Map;e.registerModule=r,e.deregisterModules=i,e.publish=a,e.subscribe=s,e.mute=u,e.muteAll=c,e.unmute=l,e.unsubscribeFunctionFromAllTopics=f}),require.register("fodderIndicator.js",function(e,t,n){function r(){l("[data-fate-weapon-registered]").each(function(e,t){l(this).children(".fate-fodder.fate-glyph.fglyph-up").length>0||l(this).append(l("<div>",{"class":"fate-fodder fate-middling fate-glyph fglyph-up",style:"display:none"}))})}function i(){var e=new Map;return l("[data-fate-weapon-registered]").each(function(t,n){if("true"!==l(this).attr("data-fate-weapon-junk")&&l(this).is("[data-fate-weapon-rarity=legendary],[data-fate-weapon-rarity=exotic]")){var r=l(this).attr("data-fate-weapon-name"),i=l(this).attr("data-fate-weapon-type"),o=l(this).attr("data-fate-base-light"),a=l(this).is("[data-fate-is-modded]"),s={type:i,isModded:a,light:parseInt(o),domElement:this,toString:function(){return i+" - "+r+" ("+o+")"}};e.has(i)?e.set(i,e.get(i).concat(s)):e.set(i,[s])}}),e}function o(e){l(".fate-fodder").hide(),l(".fate-fodder").removeClass("fate-left-bump"),l(".fate-fodder").parent().each(function(t,n){var r="true"===l(this).attr("data-fate-weapon-junk"),i="true"===l(this).attr("data-fate-weapon-dupe");if(r||i){var o=l(this).attr("data-fate-weapon-type"),a=e.get(o);if(void 0!==a){var s=parseInt(l(this).attr("data-fate-base-light"));a.filter(function(e){return e.light<s}).length>0&&(l(this).children(".fate-infusion:visible").length>0&&l(this).children(".fate-fodder").addClass("fate-left-bump"),l(this).children(".fate-fodder").show())}}})}function a(){l("[drag-channel=Kinetic],[drag-channel=Energy],[drag-channel=Power]").addClass("fate-search-hidden"),l(this).parent().removeClass("fate-search-hidden");var e=l(this).parent().attr("data-fate-weapon-type"),t=l(this).parent().attr("data-fate-base-light");l('[data-fate-weapon-type="'+e+'"]').each(function(e,n){if("true"!==l(this).attr("data-fate-weapon-junk")&&l(this).is("[data-fate-weapon-rarity=legendary],[data-fate-weapon-rarity=exotic]")){var r=parseInt(l(this).attr("data-fate-base-light"))<t;r&&l(this).removeClass("fate-search-hidden")}})}function s(){l(".fate-search-hidden").removeClass("fate-search-hidden")}function u(){l(".fate-fodder:visible").on("mouseenter.fodder",a),l(".fate-fodder:visible").on("mouseleave.fodder",s)}const c=t("fateBus.js");c.registerModule(n);var l=t("jquery"),f=t("logger.js");c.subscribe(n,"fate.infusionCalculated",function(){f.log("fodderIndicator.js: Calculating fodder"),r(),o(i()),u()}),/*
  jasmine-jquery doesn't seem to play well these days. Not sure why but it can't
  seem to trigger events via $.trigger, so we're going to use our bus to test the
  events.
*/
c.subscribe(n,"fate.test.mouseenter.fodder",function(e,t){l(t).each(a)}),c.subscribe(n,"fate.test.mouseleave.fodder",function(e,t){l(t).each(s)})}),require.register("ignoreStatusIndicator.js",function(e,t,n){function r(){s("[data-fate-weapon-name],[data-fate-shader-name]").each(function(e,t){s(this).children(".fate-ignore-slot.fate-glyph").length>0||s(this).append(s("<div>",{"class":"fate-ignore-slot fate-glyph",style:"display:none"}))})}function i(){s("[data-fate-weapon-name]").each(function(e,t){s(this).children(".fate-ignore-slot").removeClass("fate-question-mark fglyph-question-mark fate-thumbs-down fglyph-thumbs-down"),s(this).is("[data-fate-weapon-registered]")?"true"===s(this).attr("data-fate-weapon-junk")?(s(this).children(".fate-ignore-slot").addClass("fate-thumbs-down fglyph-thumbs-down fate-middling"),s(this).children(".fate-ignore-slot").show()):s(this).children(".fate-ignore-slot").hide():(s(this).children(".fate-ignore-slot").addClass("fate-question-mark fglyph-question-mark fate-middling"),s(this).children(".fate-ignore-slot").show())})}function o(){s("[data-fate-shader-name]").each(function(e,t){s(this).children(".fate-ignore-slot").removeClass("fate-question-mark fglyph-question-mark fate-thumbs-down fglyph-thumbs-down"),s(this).is("[data-fate-shader-registered]")?"false"===s(this).attr("data-fate-shader-keep")?(s(this).children(".fate-ignore-slot").addClass("fate-thumbs-down fglyph-thumbs-down fate-middling"),s(this).children(".fate-ignore-slot").show()):s(this).children(".fate-ignore-slot").hide():(s(this).children(".fate-ignore-slot").addClass("fate-question-mark fglyph-question-mark fate-middling"),s(this).children(".fate-ignore-slot").show())})}const a=t("fateBus.js");a.registerModule(n);var s=t("jquery"),u=t("logger.js");a.subscribe(n,"fate.refresh",function(){u.log("ignoreStatusIndicator.js: Calculating ignore status"),r(),i(),o()})}),require.register("infusionIndicator.js",function(e,t,n){function r(){l("[data-fate-weapon-registered]").not("[data-fate-weapon-junk]").each(function(e,t){l(this).is("[data-fate-weapon-rarity=legendary],[data-fate-weapon-rarity=exotic]")&&(l(this).children(".fate-infusion.fate-glyph.fglyph-up").length>0||l(this).append(l("<div>",{"class":"fate-infusion fate-positive fate-glyph fglyph-up",style:"display:none"})))})}function i(){var e=new Map;return l("[data-fate-weapon-registered]").each(function(t,n){if(l(this).is("[data-fate-weapon-dupe],[data-fate-weapon-junk]")){l(this).attr("data-fate-infuse-ok",!0);var r=l(this).attr("data-fate-weapon-name"),i=l(this).attr("data-fate-weapon-type"),o=l(this).attr("data-fate-base-light"),a=l(this).is("[data-fate-is-modded]"),s={type:i,isModded:a,light:parseInt(o),domElement:this,toString:function(){return i+" - "+r+" ("+o+")"}};e.has(i)?e.set(i,e.get(i).concat(s)):e.set(i,[s])}}),e}function o(e){l(".fate-infusion").hide(),l(".fate-infusion").parent().each(function(t,n){var r=l(this).attr("data-fate-weapon-type"),i=e.get(r);if(void 0!==i){var o=parseInt(l(this).attr("data-fate-base-light"));i.filter(function(e){return e.light>o}).length>0&&l(this).children(".fate-infusion").show()}})}function a(){l("[drag-channel=Kinetic],[drag-channel=Energy],[drag-channel=Power]").addClass("fate-search-hidden"),l(this).parent().removeClass("fate-search-hidden");var e=l(this).parent().attr("data-fate-weapon-type"),t=l(this).parent().attr("data-fate-base-light");l('[data-fate-weapon-type="'+e+'"]').each(function(e,n){var r=parseInt(l(this).attr("data-fate-base-light"))>t;if(void 0!=l(this).attr("data-fate-infuse-ok")&&r){var i=parseInt(l(this).attr("data-fate-base-light"));l(this).append(l("<div>",{"class":"fate-infuse-new-light"}).text(i)),l(this).removeClass("fate-search-hidden")}})}function s(){l(".fate-search-hidden").removeClass("fate-search-hidden"),l(".fate-infuse-new-light").remove()}function u(){l(".fate-infusion:visible").on("mouseenter.infuse",a),l(".fate-infusion:visible").on("mouseleave.infuse",s)}const c=t("fateBus.js");c.registerModule(n);var l=t("jquery"),f=t("logger.js");c.subscribe(n,"fate.dupesCalculated",function(){f.log("infusionIndicator.js: Calculating infuseables"),r();var e=i();o(e),u(),c.publish(n,"fate.infusionCalculated")}),/*
  jasmine-jquery doesn't seem to play well these days. Not sure why but it can't
  seem to trigger events via $.trigger, so we're going to use our bus to test the
  events.
*/
c.subscribe(n,"fate.test.mouseenter.infuse",function(e,t){l(t).each(a)}),c.subscribe(n,"fate.test.mouseleave.infuse",function(e,t){l(t).each(s)})}),require.register("itemDataRefresher.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}const i=t("fateBus.js");i.registerModule(n);var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=t("logger"),s=t("blueimp-md5");e.ItemDataRefresher=function(){function e(t,o){r(this,e),this.itemType=t,this.dataTSVURL=o,this.subscriptionFunction=this.refresh.bind(this),i.subscribe(n,"fate.itemDataStale",this.subscriptionFunction),i.subscribe(n,"fate.configurationLoaded",this.deregister.bind(this))}return o(e,[{key:"onLoadHandler",value:function(e){a.log("itemDataRefresher.js ("+this.itemType+"): data fetched");var t=e.responseText,r=s(t);return this.rawDataMD5===r?void a.log("itemDataRefresher.js ("+this.itemType+"): Checksums match, skipping refresh"):(this.rawDataMD5=r,a.log("itemDataRefresher.js ("+this.itemType+"): Modified data, triggering refresh"),void i.publish(n,"fate."+this.itemType+"DataFetched",t.substring(t.indexOf("\n")+1)))}},{key:"refresh",value:function(){GM_xmlhttpRequest({method:"GET",url:this.dataTSVURL,onload:this.onLoadHandler.bind(this)})}},{key:"deregister",value:function(){i.unsubscribeFunctionFromAllTopics(this.subscriptionFunction)}}]),e}()}),require.register("itemDatabase.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}const i=t("fateBus.js");i.registerModule(n);var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=t("logger"),s=(t("weapon.js"),function(){function e(t){r(this,e),this.itemType=t,this.itemMap=new Map,i.subscribe(n,"fate."+this.itemType+"DataFetched",this.refresh.bind(this))}return o(e,[{key:"refresh",value:function(e,t){this.itemMap.clear();var n=t.split(/[\r\n]+/),r=!0,i=!1,o=void 0;try{for(var s,u=n[Symbol.iterator]();!(r=(s=u.next()).done);r=!0){var c=s.value;this.createItemFromData(c.split("\t"))}}catch(l){i=!0,o=l}finally{try{!r&&u["return"]&&u["return"]()}finally{if(i)throw o}}a.log("itemDatabase.js ("+this.itemType+"): Found ("+n.length+") items")}},{key:"createItemFromData",value:function(e){}},{key:"contains",value:function(e){return this.itemMap.has(e)}},{key:"get",value:function(e){return this.itemMap.get(e)}}]),e}());e.ItemDatabase=s}),require.register("logger.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n);var i=!1;e.setEnabled=function(e){i=e},e.log=function(e){i&&GM_log("[FATE] "+e)}}),require.register("main.js",function(e,t,n){const r=t("fateBus.js");/*
...
t("rollAssessment.js"),t("rollDatabase.js"),t("rollDataRefresher.js"),!window.navigator.userAgent.includes("HeadlessChrome")){var i=t("logger");i.log("main.js: Initializing"),r.publish(n,"fate.init"),r.publish(n,"fate.itemDataStale"),r.publish(n,"fate.refresh"),setInterval(function(){r.publish(n,"fate.refresh")},1e4),setInterval(function(){r.publish(n,"fate.itemDataStale")},6e4)}}),require.register("masterworkIndicator.js",function(e,t,n){function r(){a("[data-fate-masterwork]").each(function(e,t){a(this).children(".fate-masterwork").length>0||a(this).append(a('<div class="fate-masterwork" style="display:none">M</div>'))})}function i(){a("[data-fate-masterwork]").each(function(e,t){"true"===a(this).attr("data-fate-masterwork")?a(this).children(".fate-masterwork").show():a(this).children(".fate-masterwork").hide()})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("logger.js");o.subscribe(n,"fate.refresh",function(){s.log("masterworkIndicator.js: Calculating masterworks"),r(),i()})}),require.register("pveIndicator.js",function(e,t,n){function r(){a("[data-fate-weapon-registered]").each(function(e,t){a(this).children(".fate-pve.fate-glyph.fglyph-pve").length>0||a(this).append(a("<div>",{"class":"fate-pve fate-glyph fglyph-pve",style:"display:none"}))})}function i(){a("[data-fate-weapon-registered]").each(function(e,t){return a(this).is("[data-fate-weapon-pve]")?(a(this).is("[data-fate-weapon-pvp]")&&a(this).children(".fate-pve").addClass("fate-right-bump"),void a(this).children(".fate-pve").show()):void a(this).children(".fate-pve").hide()})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("logger.js");o.subscribe(n,"fate.pvpsCalculated",function(){s.log("pveIndicator.js: Calculating pve useful weapons"),r(),i(),o.publish(n,"fate.pvesCalculated")})}),require.register("pvpIndicator.js",function(e,t,n){function r(){a("[data-fate-weapon-registered]").each(function(e,t){a(this).children(".fate-pvp.fate-glyph.fglyph-pvp").length>0||a(this).append(a("<div>",{"class":"fate-pvp fate-glyph fglyph-pvp",style:"display:none"}))})}function i(){a("[data-fate-weapon-registered]").each(function(e,t){a(this).is("[data-fate-weapon-pvp]")?a(this).children(".fate-pvp").show():a(this).children(".fate-pvp").hide()})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("logger.js");o.subscribe(n,"fate.refresh",function(){s.log("pvpIndicator.js: Calculating pvp useful weapons"),r(),i(),o.publish(n,"fate.pvpsCalculated")})}),require.register("rollAssessment.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}const i=t("fateBus.js");i.registerModule(n);var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=t("weapon.js"),s=function(){function e(t,n,i,o,a){r(this,e),this.rollID=t,this.name=n,this.pve=i.toLowerCase(),this.pvp=o.toLowerCase(),this.comments=a}return o(e,[{key:"isJunk",value:function(){return this.pveUtility===a.Utility.NO&&this.pvpUtility===a.Utility.NO}},{key:"pveUtility",get:function(){return a.Weapon.mapToStatus(this.pve)}},{key:"pvpUtility",get:function(){return a.Weapon.mapToStatus(this.pvp)}}]),e}();e.RollAssessment=s}),require.register("rollDataRefresher.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n);var i=t("itemDataRefresher.js");r.subscribe(n,"fate.configurationLoaded",function(e,t){new i.ItemDataRefresher("roll",t.rollDataTSV)})}),require.register("rollDatabase.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function o(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}const a=t("fateBus.js");a.registerModule(n);var s=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),u=(t("logger"),t("itemDatabase.js")),c=t("rollAssessment.js"),l=function(e){function t(){return r(this,t),i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,"roll"))}return o(t,e),s(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],new c.RollAssessment(e[0],e[1],e[2],e[3],e[4]))}}]),t}(u.ItemDatabase);e.rollDB=new l}),require.register("shader.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}const i=t("fateBus.js");i.registerModule(n);var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a={NO:"n",YES:"y",UNKNOWN:"?"},s=function(){function e(t,n,i){r(this,e),this.name=t,this.keep=n.toLowerCase(),this.comments=i}return o(e,[{key:"keepStatus",get:function(){switch(this.keep){case"y":return a.YES;case"n":return a.NO;default:return a.UNKNOWN}}}]),e}();e.Shader=s,e.Keep=a}),require.register("shaderDataRefresher.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n);var i=t("itemDataRefresher.js");r.subscribe(n,"fate.configurationLoaded",function(e,t){new i.ItemDataRefresher("shader",t.shaderDataTSV)})}),require.register("shaderDatabase.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function o(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}const a=t("fateBus.js");a.registerModule(n);var s=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),u=(t("logger"),t("itemDatabase.js")),c=t("shader.js"),l=function(e){function t(){return r(this,t),i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,"shader"))}return o(t,e),s(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],new c.Shader(e[0],e[1],e[2]))}}]),t}(u.ItemDatabase);e.shaderDB=new l}),require.register("shaderDecorator.js",function(e,t,n){function r(){u("[drag-channel=Shaders]").not("[data-fate-shader-name]").each(function(e,t){u(this).attr("data-fate-shader-name",u(this).attr("title").split("\n")[0])})}function i(){u("[data-fate-shader-name]").each(function(e,t){var n=u(this).attr("data-fate-shader-name");l.contains(n)&&u(this).attr("data-fate-shader-registered",!0)})}function o(){u("[data-fate-shader-registered]").each(function(e,t){var n=l.get(u(this).attr("data-fate-shader-name"));n.keepStatus===c.Keep.YES?u(this).attr("data-fate-shader-keep",!0):n.keepStatus===c.Keep.NO?u(this).attr("data-fate-shader-keep",!1):u(this).removeAttr("data-fate-shader-keep")})}function a(){u("[data-fate-shader-registered]").each(function(e,t){var n=l.get(u(this).attr("data-fate-shader-name"));u(this).attr("data-fate-comment",n.comments)})}const s=t("fateBus.js");s.registerModule(n);var u=t("jquery"),c=t("shader.js"),l=t("shaderDatabase.js").shaderDB;s.subscribe(n,"fate.refresh",function(){r(),i(),o(),a()})}),require.register("weapon.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}const i=t("fateBus.js");i.registerModule(n);var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a={NO:"n",YES:"y",UNKNOWN:"?"};e.Weapon=function(){function e(t,n,i,o,a,s){r(this,e),this.name=t,this.rarity=n.toLowerCase(),this.type=i,this.pve=o.toLowerCase(),this.pvp=a.toLowerCase(),this.comments=s}return o(e,[{key:"isJunk",value:function(){return this.pveUtility===a.NO&&this.pvpUtility===a.NO}},{key:"pveUtility",get:function(){return e.mapToStatus(this.pve)}},{key:"pvpUtility",get:function(){return e.mapToStatus(this.pvp)}}],[{key:"mapToStatus",value:function(e){switch(e){case"y":return a.YES;case"n":return a.NO;default:return a.UNKNOWN}}}]),e}(),e.Utility=a}),require.register("weaponDataRefresher.js",function(e,t,n){function r(e,t){l=t.weaponDataTSV}function i(e){s.log("weaponDataRefresher.js: Weapon data fetched");var t=e.responseText;return c===u(t)?void s.log("weaponDataRefresher.js: Checksums match, skipping refresh"):(c=u(t),s.log("weaponDataRefresher.js: Modified data, triggering refresh"),void a.publish(n,"fate.weaponDataFetched",t.substring(t.indexOf("\n")+1)))}function o(){GM_xmlhttpRequest({method:"GET",url:l,onload:i})}const a=t("fateBus.js");a.registerModule(n);var s=t("logger"),u=t("blueimp-md5"),c=void 0,l=void 0;a.subscribe(n,"fate.configurationLoaded",r),a.subscribe(n,"fate.itemDataStale",o)}),require.register("weaponDatabase.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function o(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}const a=t("fateBus.js");a.registerModule(n);var s=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),u=(t("logger"),t("itemDatabase.js")),c=t("weapon.js"),l=function(e){function t(){return r(this,t),i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,"weapon"))}return o(t,e),s(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],new c.Weapon(e[0],e[1],e[2],e[3],e[4],e[5]))}}]),t}(u.ItemDatabase);e.weaponDB=new l}),require.register("weaponDecorator.js",function(e,t,n){function r(){c("[drag-channel=Kinetic],[drag-channel=Energy],[drag-channel=Power]").not("[data-fate-weapon-name]").each(function(e,t){var n=c(this).attr("title").split("\n")[0];c(this).attr("data-fate-weapon-name",n);var r=c(this).children(".item-img.complete").length>0;c(this).attr("data-fate-is-modded",r);var i=c(this).children(".item-img.masterwork").length>0;c(this).attr("data-fate-masterwork",i);var o=parseInt(c(this).children(".item-stat.item-equipment").text().match(/(\d+)/)),a=r?o-5:o;c(this).attr("data-fate-base-light",a),f.contains(n)&&(c(this).attr("data-fate-weapon-registered",!0),c(this).attr("data-fate-serial",c(this).attr("id").split("-")[0]),c(this).attr("data-fate-weapon-rarity",f.get(n).rarity),c(this).attr("data-fate-weapon-type",f.get(n).type),c(this).attr("data-fate-roll-stored",d.contains(c(this).attr("data-fate-serial"))))})}function i(){c("[data-fate-weapon-registered]").each(function(e,t){d.contains(c(this).attr("data-fate-serial"))?c(this).attr("data-fate-weapon-junk",d.get(c(this).attr("data-fate-serial")).isJunk()):c(this).attr("data-fate-weapon-junk",f.get(c(this).attr("data-fate-weapon-name")).isJunk())})}function o(){c("[data-fate-weapon-registered]").each(function(e,t){var n=s(c(this));n.pvpUtility===l.Utility.YES?c(this).attr("data-fate-weapon-pvp",!0):c(this).removeAttr("data-fate-weapon-pvp"),n.pveUtility===l.Utility.YES?c(this).attr("data-fate-weapon-pve",!0):c(this).removeAttr("data-fate-weapon-pve")})}function a(){c("[data-fate-weapon-registered]").each(function(e,t){c(this).attr("data-fate-comment",s(c(this)).comments)})}function s(e){return d.contains(e.attr("data-fate-serial"))?d.get(e.attr("data-fate-serial")):f.contains(e.attr("data-fate-weapon-name"))?f.get(e.attr("data-fate-weapon-name")):void 0}const u=t("fateBus.js");u.registerModule(n);var c=t("jquery"),l=t("weapon.js"),f=t("weaponDatabase.js").weaponDB,d=t("rollDatabase.js").rollDB;u.subscribe(n,"fate.refresh",function(){r(),o(),i(),a()})}),require.alias("blueimp-md5/js/md5.js","blueimp-md5"),require.alias("jquery/dist/jquery.js","jquery"),require.alias("process/browser.js","process"),require.alias("pubsub-js/src/pubsub.js","pubsub-js"),e=require("process"),require.register("___globals___",function(e,t,n){})}(),require("___globals___"),GM_configStruct.prototype={
