...
function(e){function t(){return i(this,t),s(this,c(t).call(this,"weaponRoll"))}return l(t,e),a(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],new h.WeaponRollAssessment(e[0],e[1],e[2],e[3],e[4],e[5]))}}]),t}(p.ItemDatabase);e.weaponRollDB=new g}),require.alias("blueimp-md5/js/md5.js","blueimp-md5"),require.alias("jquery/dist/jquery.js","jquery"),require.alias("jquery-toast-plugin/dist/jquery.toast.min.js","jquery-toast-plugin"),require.alias("process/browser.js","process"),require.alias("pubsub-js/src/pubsub.js","pubsub-js"),e=require("process"),require.register("___globals___",function(e,t,n){})}(),require("___globals___"),GM_configStruct.prototype={
