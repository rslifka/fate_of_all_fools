...
return"true"===e||"false"!==e&&("null"===e?null:e===+e+""?+e:Ve.test(e)?JSON.parse(e):e)}function v(e,t,n){var r;
...
function A(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function q(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function M(e,t){var n,r,i,o,a,s,u,c;if(1===t.nodeType){
...
B="sizzle"+1*new Date,F=e.document,G=0,W=0,$=n(),V=n(),z=n(),U=n(),X=function(e,t){return e===t&&(A=!0),0},
// Instance methods
...
return n?n:(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1,1&n||!j.sortDetached&&t.compareDocumentPosition(e)===n?e===M||e.ownerDocument===F&&P(F,e)?-1:t===M||t.ownerDocument===F&&P(F,t)?1:N?te(N,e)-te(N,t):0:4&n?-1:1)}:function(e,t){
// Exit early if the nodes are identical
if(e===t)return A=!0,0;var n,r=0,i=e.parentNode,o=t.parentNode,s=[e],u=[t];
// Parentless nodes are either documents or disconnected
if(!i||!o)return e===M?-1:t===M?1:i?-1:o?1:N?te(N,e)-te(N,t):0;if(i===o)return a(e,t);for(
...
// Cache the tokens
return n?s.length:s?t.error(e):V(e,u).slice(0)},k=t.compile=function(e,t){var n,r=[],i=[],o=z[e+" "];if(!o){for(
...
Ae=Ce(ue);var Oe=/^(?:parents|prev(?:Until|All))/,
...
e()||n[t]!==e||n.splice(t--,1);n.length||Ce.fx.stop(),Ct=void 0},Ce.fx.timer=function(e){Ce.timers.push(e),Ce.fx.start()},Ce.fx.interval=13,Ce.fx.start=function(){St||(St=!0,V())},Ce.fx.stop=function(){St=null},Ce.fx.speeds={slow:600,fast:200,
// Default speed
_default:400},
...
getResponseHeader:function(e){var t;if(l){if(!s)for(s={};t=Vt.exec(a);)s[t[1].toLowerCase()+" "]=(s[t[1].toLowerCase()+" "]||[]).concat(t[2]);t=s[e.toLowerCase()+" "]}return null==t?null:t.join(", ")},
// Raw string
