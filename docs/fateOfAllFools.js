...
e.querySelectorAll("*,:x"),I.push(",.*:")})),(j.matchesSelector=me.test(F=M.matches||M.webkitMatchesSelector||M.mozMatchesSelector||M.oMatchesSelector||M.msMatchesSelector))&&i(function(e){
// Check to see if it's possible to do matchesSelector
// on a disconnected node (IE 9)
j.disconnectedMatch=F.call(e,"*"),
// This should fail with an exception
// Gecko does not error, returns false instead
F.call(e,"[s!='']:x"),H.push("!=",oe)}),I=I.length&&new RegExp(I.join("|")),H=H.length&&new RegExp(H.join("|")),t=me.test(M.compareDocumentPosition),P=t||me.test(M.contains)?function(e,t){var n=9===e.nodeType?e.documentElement:e,r=t&&t.parentNode;return e===r||!(!r||1!==r.nodeType||!(n.contains?n.contains(r):e.compareDocumentPosition&&16&e.compareDocumentPosition(r)))}:function(e,t){if(t)for(;t=t.parentNode;)if(t===e)return!0;return!1},z=t?function(e,t){
...
return n?n:(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1,1&n||!j.sortDetached&&t.compareDocumentPosition(e)===n?e===O||e.ownerDocument===B&&P(B,e)?-1:t===O||t.ownerDocument===B&&P(B,t)?1:N?ee(N,e)-ee(N,t):0:4&n?-1:1)}:function(e,t){
...
n=n.replace(le,"='$1']"),j.matchesSelector&&L&&!V[n+" "]&&(!H||!H.test(n))&&(!I||!I.test(n)))try{var r=F.call(e,n);
...
// Set document vars if needed
return(e.ownerDocument||e)!==O&&A(e),P(e,t)},t.attr=function(e,t){
// Set document vars if needed
...
u.subscribe(n,"fate.test.mouseenter.dupe",function(e,t){l(t).each(o)}),u.subscribe(n,"fate.test.mouseleave.dupe",function(e,t){l(t).each(a)})}),require.register("fateBus.js",function(e,t,n){"use strict";function r(e){p.set(e.id,!1)}function i(){p.clear()}function o(e){return p.get(e.id)}function a(e,t,n){if(!p.has(e.id))throw new Error("fateBus.js#publish: Module ["+e.id+"] is not defined");o(e)||d.publishSync(t,n)}function s(e,t,n){if(!p.has(e.id))throw new Error("fateBus.js#subscribe: Module ["+e.id+"] is not defined");d.subscribe(t,function(t,r){p.has(e.id)&&(o(e)||n(t,r))})}function u(e){p.set(e,!0)}function c(){var e=Array.from(p.keys());e.forEach(function(e){u(e)})}function l(e){p.set(e,!1)}function f(e){d.unsubscribe(e)}var d=t("pubsub-js"),p=new Map;e.registerModule=r,e.deregisterModules=i,e.publish=a,e.subscribe=s,e.mute=u,e.muteAll=c,e.unmute=l,e.unsubscribeFunctionFromAllTopics=f}),require.register("fodderIndicator.js",function(e,t,n){function r(){l('[data-fate-weapon-registered="true"]').each(function(e,t){l(this).children(".fate-fodder.fate-glyph.fglyph-up").length>0||l(this).append(l("<div>",{"class":"fate-fodder fate-middling fate-glyph fglyph-up",style:"display:none"}))})}function i(){var e=new Map;return l('[data-fate-weapon-registered="true"]').each(function(t,n){if("true"!==l(this).attr("data-fate-weapon-junk")&&l(this).is("[data-fate-weapon-rarity=legendary],[data-fate-weapon-rarity=exotic]")){var r=l(this).attr("data-fate-weapon-name"),i=l(this).attr("data-fate-weapon-type"),o=l(this).attr("data-fate-base-light"),a={type:i,light:parseInt(o),domElement:this,toString:function(){return i+" - "+r+" ("+o+")"}};e.has(i)?e.set(i,e.get(i).concat(a)):e.set(i,[a])}}),e}function o(e){l(".fate-fodder").hide(),l(".fate-fodder").removeClass("fate-left-bump"),l(".fate-fodder").parent().each(function(t,n){var r="true"===l(this).attr("data-fate-weapon-junk"),i="true"===l(this).attr("data-fate-weapon-dupe");if(r||i){var o=l(this).attr("data-fate-weapon-type"),a=e.get(o);if(void 0!==a){var s=parseInt(l(this).attr("data-fate-base-light"));a.filter(function(e){return e.light<s}).length>0&&(l(this).children(".fate-infusion:visible").length>0&&l(this).children(".fate-fodder").addClass("fate-left-bump"),l(this).children(".fate-fodder").show())}}})}function a(){l("[drag-channel=Kinetic],[drag-channel=Energy],[drag-channel=Power]").addClass("fate-search-hidden"),l(this).parent().removeClass("fate-search-hidden");var e=l(this).parent().attr("data-fate-weapon-type"),t=l(this).parent().attr("data-fate-base-light");l('[data-fate-weapon-type="'+e+'"]').each(function(e,n){if("true"!==l(this).attr("data-fate-weapon-junk")&&l(this).is("[data-fate-weapon-rarity=legendary],[data-fate-weapon-rarity=exotic]")){var r=parseInt(l(this).attr("data-fate-base-light"))<t;r&&l(this).removeClass("fate-search-hidden")}})}function s(){l(".fate-search-hidden").removeClass("fate-search-hidden")}function u(){l(".fate-fodder:visible").on("mouseenter.fodder",a),l(".fate-fodder:visible").on("mouseleave.fodder",s)}const c=t("fateBus.js");c.registerModule(n);var l=t("jquery"),f=t("logger.js");c.subscribe(n,"fate.infusionCalculated",function(){f.log("fodderIndicator.js: Calculating fodder"),r(),o(i()),u()}),/*
  ...
  events.
*/
c.subscribe(n,"fate.test.mouseenter.fodder",function(e,t){l(t).each(a)}),c.subscribe(n,"fate.test.mouseleave.fodder",function(e,t){l(t).each(s)})}),require.register("indicators.js",function(e,t,n){function r(){o("[data-fate-weapon-name]").not('[data-fate-indicator-init="true"]').each(function(e,t){p.forEach(function(e,n){o(t).append(o("<div>",{"class":n+" "+e+" foaf-glyph"}))}),o(this).append(o('<div class="foaf-masterwork foaf-glyph">M</div>')),o(this).attr("data-fate-indicator-init",!0)})}const i=t("fateBus.js");i.registerModule(n);var o=t("jquery"),a=t("logger.js"),s="foaf-dupe",u="foaf-unregistered",c="foaf-junk",l="foaf-pve",f="foaf-pvp",d="foaf-infusable",p=new Map([[s,"fglyph-knives"],[u,"fglyph-question-mark"],[c,"fglyph-thumbs-down"],[l,"fglyph-pve"],[f,"fglyph-pvp"],[d,"fglyph-up"]]);i.subscribe(n,"fate.refresh",function(){a.log("indicators.js: Inserting indicator elements"),r()}),e.DUPLICATE_INDICATOR_CLASS=s,e.INFUSION_INDICATOR_CLASS=d}),require.register("infusionIndicator.js",function(e,t,n){function r(){f.clear(),c('[data-fate-weapon-registered="true"]').each(function(e,t){if(!(c(this).is('[data-fate-weapon-dupe="false"]')&&c(this).is('[data-fate-weapon-junk="false"]')||c(this).is('[data-fate-weapon-rarity="common"]')||c(this).is('[data-fate-weapon-rarity="uncommon"]'))){var n=c(this).attr("data-fate-weapon-name"),r=c(this).attr("drag-channel"),i=parseInt(c(this).attr("data-fate-base-light")),o={slot:r,light:i,domElement:this,toString:function(){return r+" - "+n+" ("+i+")"}};f.has(r)?f.set(r,f.get(r).concat(o)):f.set(r,[o])}})}function i(){c("[data-fate-weapon-name]").each(function(e,t){if(c(this).is('[data-fate-weapon-registered="false"]'))return void c(this).attr("data-fate-infusable",!1);if(c(this).is('[data-fate-weapon-junk="true"]'))return void c(this).attr("data-fate-infusable",!1);if(!c(this).is('[data-fate-weapon-rarity="legendary"],[data-fate-weapon-rarity="exotic"]'))return void c(this).attr("data-fate-infusable",!1);var n=f.get(c(this).attr("drag-channel"));if(void 0===n)return void c(this).attr("data-fate-infusable",!1);var r=parseInt(c(this).attr("data-fate-base-light"));n.filter(function(e){return e.light>r}).length>0?c(this).attr("data-fate-infusable",!0):c(this).attr("data-fate-infusable",!1)})}function o(){var e=c(this).parent().attr("drag-channel"),t=c(this).parent().attr("data-fate-base-light"),n=f.get(e);
// Hide all weapons in the same slot
c("[drag-channel="+e+"]").addClass("fate-search-hidden"),
// Show the current weapon
c(this).parent().removeClass("fate-search-hidden"),
// console.log(fodder);
// Show valid fodder in this slot
n.filter(function(e){return e.light>t}).forEach(function(e){c(e.domElement).removeClass("fate-search-hidden")})}function a(){c(".fate-search-hidden").removeClass("fate-search-hidden")}function s(){c(".foaf-infusable").on("mouseenter.infuse",o),c(".foaf-infusable").on("mouseleave.infuse",a)}const u=t("fateBus.js");u.registerModule(n);var c=t("jquery"),l=t("logger.js"),f=new Map;u.subscribe(n,"fate.dupesCalculated",function(){l.log("infusionIndicator.js: Calculating infuseables"),r(),i(),s(),u.publish(n,"fate.infusionCalculated")}),/*
  jasmine-jquery doesn't seem to play well these days. Not sure why but it can't
  seem to trigger events via $.trigger, so we're going to use our bus to test the
  events.
*/
