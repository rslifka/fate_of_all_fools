...
break}if(u)for(i in r)r.hasOwnProperty(i)&&r[i]===t&&(delete r[i],l=!0)}return l}})}()}),require.register("armorDecorator.js",function(e,t,n){function r(){s(f).not("[data-fate-armor-init]").each(function(e,t){
// Don't mistake popups for gear (popups don't have carraige returns in them)
if(s(this).attr("title").includes("\n")){s(this).attr("data-fate-armor-init",!0);var n=s(this).attr("title").split("\n")[0];s(this).attr("data-fate-armor-name",n);var r=s(this).has("._2kz8P").length+s(this).has("._3iMN1").length>0;s(this).attr("data-fate-masterwork",r);var i=s(this).attr("id").split("-")[0];s(this).attr("data-fate-serial",i)}})}function i(){s("[data-fate-armor-init=true][data-fate-indicator-init=true]").each(function(e,t){var n=s(this).attr("data-fate-serial"),r=s.map(s(this).find("svg"),function(e,t){return s(e).attr("data-icon")});s(this).attr("data-fate-dim-tags",r.join(","));var i=u.contains(n);if(s(this).attr("data-fate-armor-registered",i),!i)return s(this).removeAttr("data-fate-comment"),s(this).removeAttr("data-fate-armor-junk"),s(this).removeAttr("data-fate-armor-pve"),void s(this).removeAttr("data-fate-armor-pvp");var a=u.get(n);s(this).attr("data-fate-comment",a.comments),s(this).attr("data-fate-armor-junk",a.pveUtility===c.NO&&a.pvpUtility===c.NO),s(this).attr("data-fate-armor-pve",a.pveUtility===c.YES),s(this).attr("data-fate-armor-pvp",a.pvpUtility===c.YES);var l=""+a.mob+a.res+a.rec+a["int"]+a.dis+a.str;s(this).attr("data-fate-stat-check")!==l&&(s(this).attr("data-fate-stat-check",l),s(this).find(".foaf-total").text(a.total).addClass(o(a.total)))})}function o(e){return e<=45?"foaf-stat-low":e<=50?"foaf-stat-med":"foaf-stat-high"}const a=t("fateBus.js");a.registerModule(n);var s=t("jquery"),u=t("armorRollDatabase.js").armorRollDB,c=t("armorRoll.js").Utility,l=["Helmet","Gauntlets","Chest Armor","Leg Armor","Warlock Bond","Titan Mark","Hunter Cloak"],f=l.map(function(e){return"[title$='"+e+"']"}).join(",");a.subscribe(n,"fate.refresh",function(){r(),i()})}),require.register("armorRoll.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function o(e,t,n){return t&&i(e.prototype,t),n&&i(e,n),e}const a=t("fateBus.js");a.registerModule(n);var s={NO:"n",YES:"y",UNKNOWN:"?"},u=/*#__PURE__*/
