...
if(void 0===n&&1===e.nodeType)if(r="data-"+t.replace(Fe,"-$&").toLowerCase(),n=e.getAttribute(r),"string"==typeof n){try{n=d(n)}catch(i){}
...
// Reenable scripts
ge.map(s,S),f=0;f<u;f++)c=s[f],Xe.test(c.type||"")&&!Re.access(c,"globalEval")&&ge.contains(l,c)&&(c.src?
...
return n=n||ut(e),n&&(a=n.getPropertyValue(t)||n[t],""!==a||ge.contains(e.ownerDocument,e)||(a=ge.style(e,t)),!de.pixelMarginRight()&&st.test(a)&&at.test(t)&&(r=s.width,i=s.minWidth,o=s.maxWidth,s.minWidth=s.maxWidth=s.width=a,a=n.width,s.width=r,s.minWidth=i,s.maxWidth=o)),void 0!==a?a+"":a}function O(e,t){
...
return r}function $(e,t,n){var r,i,o,a,s,u,c,l,f="width"in t||"height"in t,p=this,d={},h=e.style,g=e.nodeType&&Ge(e),m=Re.get(e,"fxshow");
...
// TODO: identify versions
// getElementById can match elements by name instead of ID
if(p&&(a=p.getElementById(i))&&F(t,a)&&a.id===i)return n.push(a),n}else{if(u[2])return J.apply(n,t.getElementsByTagName(e)),n;if((i=u[3])&&j.getElementsByClassName&&t.getElementsByClassName)return J.apply(n,t.getElementsByClassName(i)),n}
// Take advantage of querySelectorAll
if(j.qsa&&!V[e+" "]&&(!R||!R.test(e))){if(1!==h)p=t,l=e;else if("object"!==t.nodeName.toLowerCase()){for(
...
p=ye.test(e)&&f(t.parentNode)||t}if(l)try{return J.apply(n,p.querySelectorAll(l)),n}catch(g){}finally{s===P&&t.removeAttribute("id")}}}
// All others
...
l[o]=p,p[2]=e(t,n,u))return!0}return!1}}function g(e){return e.length>1?function(t,n,r){for(var i=e.length;i--;)if(!e[i](t,n,r))return!1;return!0}:e[0]}function m(e,n,r){for(var i=0,o=n.length;i<o;i++)t(e,n[i],r);return r}function v(e,t,n,r,i){for(var o,a=[],s=0,u=e.length,c=null!=t;s<u;s++)(o=e[s])&&(n&&!n(o,r,i)||(a.push(o),c&&t.push(s)));return a}function y(e,t,n,i,o,a){return i&&!i[P]&&(i=y(i)),o&&!o[P]&&(o=y(o,a)),r(function(r,a,s,u){var c,l,f,p=[],d=[],h=a.length,
...
for(c&&(D=a===O||a||c);h!==x&&null!=(l=b[h]);h++){if(o&&l){for(f=0,a||l.ownerDocument===O||(A(l),s=!L);p=e[f++];)if(p(l,a||O,s)){u.push(l);break}c&&(W=w)}
...
P="sizzle"+1*new Date,B=e.document,W=0,G=0,$=n(),U=n(),V=n(),z=function(e,t){return e===t&&(q=!0),0},
// Instance methods
X={}.hasOwnProperty,K=[],Y=K.pop,Q=K.push,J=K.push,Z=K.slice,
...
if("*"===e){for(;n=o[i++];)1===n.nodeType&&r.push(n);return r}return o},T.find.CLASS=j.getElementsByClassName&&function(e,t){if("undefined"!=typeof t.getElementsByClassName&&L)return t.getElementsByClassName(e)},H=[],R=[],(j.qsa=me.test(O.querySelectorAll))&&(i(function(e){
...
e.querySelectorAll("a#"+P+"+*").length||R.push(".#.+[+~]")}),i(function(e){e.innerHTML="<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
...
n=n.replace(le,"='$1']"),j.matchesSelector&&L&&!V[n+" "]&&(!H||!H.test(n))&&(!R||!R.test(n)))try{var r=I.call(e,n);
...
promise:function(e,t){var n,r=1,i=ge.Deferred(),o=this,a=this.length,s=function(){--r||i.resolveWith(o,[o])};for("string"!=typeof e&&(t=e,e=void 0),e=e||"fx";a--;)n=Re.get(o[a],e+"queueHooks"),n&&n.empty&&(r++,n.empty.add(s));return s(),i.promise(t)}});var Pe=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Be=new RegExp("^(?:([+-])=|)("+Pe+")([a-z%]*)$","i"),We=["Top","Right","Bottom","Left"],Ge=function(e,t){
...
for(o in t)e.style[o]=a[o];return i},Ue={};ge.fn.extend({show:function(){return v(this,!0)},hide:function(){return v(this)},toggle:function(e){return"boolean"==typeof e?e?this.show():this.hide():this.each(function(){Ge(this)?ge(this).show():ge(this).hide()})}});var Ve=/^(?:checkbox|radio)$/i,ze=/<([a-z][^\/\0>\x20\t\r\n\f]+)/i,Xe=/^$|\/(?:java|ecma)script/i,Ke={
// Support: IE <=9 only
...
t=(t||"").match(qe)||[""],c=t.length;c--;)s=et.exec(t[c])||[],d=g=s[1],h=(s[2]||"").split(".").sort(),
...
return!ct.test(ge.css(e,"display"))||e.getClientRects().length&&e.getBoundingClientRect().width?I(e,t,r):$e(e,ft,function(){return I(e,t,r)})},set:function(e,n,r){var i,o=r&&ut(e),a=r&&H(e,t,r,"border-box"===ge.css(e,"boxSizing",!1,o),o);
// Convert to pixels if value adjustment is needed
return a&&(i=Be.exec(n))&&"px"!==(i[3]||"px")&&(e.style[t]=n,n=ge.css(e,t)),R(e,n,a)}}}),ge.cssHooks.marginLeft=O(de.reliableMarginLeft,function(e,t){if(t)return(parseFloat(A(e,"marginLeft"))||e.getBoundingClientRect().left-$e(e,{marginLeft:0},function(){return e.getBoundingClientRect().left}))+"px"}),
...
return t?J(J(e,ge.ajaxSettings),t):J(ge.ajaxSettings,e)},ajaxPrefilter:Y(Ft),ajaxTransport:Y(Pt),
// Main method
ajax:function(t,n){
...
1223:204},$t=ge.ajaxSettings.xhr();de.cors=!!$t&&"withCredentials"in $t,de.ajax=$t=!!$t,ge.ajaxTransport(function(t){var n,r;
// Cross domain only allowed if supported through XMLHttpRequest
if(de.cors||$t&&!t.crossDomain)return{send:function(i,o){var a,s=t.xhr();
...
ge.each(["top","left"],function(e,t){ge.cssHooks[t]=O(de.pixelPosition,function(e,n){if(n)
...
t("itemIdCopy.js"),t("shader.js"),t("shaderDatabase.js"),t("shaderDecorator.js"),t("shaderDataRefresher.js"),t("shaderStatusIndicator.js"),t("weapon.js"),t("weaponDatabase.js"),t("weaponDecorator.js"),t("weaponDataRefresher.js"),t("weaponRollAssessment.js"),t("weaponRollDatabase.js"),t("weaponRollDataRefresher.js"),t("armorDecorator.js"),t("armorRollAssessment.js"),t("armorRollDatabase.js"),t("armorRollDataRefresher.js"),t("indicators.js"),!window.navigator.userAgent.includes("HeadlessChrome")){var o=t("logger"),a=t("jquery");o.setEnabled(!0),o.log("main.js: Initializing"),
