...
var t=a(this).has("._2kz8P").length+a(this).has("._3iMN1").length>0;a(this).attr("data-fate-masterwork",t);var n=a(this).attr("id").split("-")[0];a(this).attr("data-fate-serial",n);var r=a(this).find(".AtD93").children("span").text();a(this).attr("data-fate-light",r)})})}function i(){a("[data-fate-weapon-registered]").each(function(e,t){var n=a(this).attr("data-fate-serial"),r=a.map(a(this).find("svg"),function(e,t){return a(e).attr("data-icon")}),i=r.includes("ban");a(this).attr("data-fate-dimjunk",i);var o="not-registered";r.includes("thumbs-up")?o="accepted":r.includes("thumbs-down")&&(o="rejected"),a(this).attr("data-fate-wishlist-status",o);var c=s.contains(n);if(a(this).attr("data-fate-weapon-registered",c),!c)return a(this).removeAttr("data-fate-comment"),a(this).removeAttr("data-fate-weapon-junk"),a(this).removeAttr("data-fate-weapon-pve"),void a(this).removeAttr("data-fate-weapon-pvp");var l=s.get(n);a(this).attr("data-fate-comment",l.comments),a(this).attr("data-fate-weapon-junk",l.pveUtility===u.NO&&l.pvpUtility===u.NO),a(this).attr("data-fate-weapon-pve",l.pveUtility===u.YES),a(this).attr("data-fate-weapon-pvp",l.pvpUtility===u.YES)})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("weaponRollDatabase.js").weaponRollDB,u=t("weaponRollAssessment.js").Utility,c=["bucket-1498876634",// Kinetic
