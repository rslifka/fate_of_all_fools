...
return r!==O&&9===r.nodeType&&r.documentElement?(O=r,M=O.documentElement,L=!k(O),B!==O&&(n=O.defaultView)&&n.top!==n&&(n.addEventListener?n.addEventListener("unload",Te,!1):n.attachEvent&&n.attachEvent("onunload",Te)),j.attributes=i(function(e){return e.className="i",!e.getAttribute("className")}),j.getElementsByTagName=i(function(e){return e.appendChild(O.createComment("")),!e.getElementsByTagName("*").length}),j.getElementsByClassName=me.test(O.getElementsByClassName),j.getById=i(function(e){return M.appendChild(e).id=R,!O.getElementsByName||!O.getElementsByName(R).length}),j.getById?(T.filter.ID=function(e){var t=e.replace(be,we);return function(e){return e.getAttribute("id")===t}},T.find.ID=function(e,t){if("undefined"!=typeof t.getElementById&&L){var n=t.getElementById(e);return n?[n]:[]}}):(T.filter.ID=function(e){var t=e.replace(be,we);return function(e){var n="undefined"!=typeof e.getAttributeNode&&e.getAttributeNode("id");return n&&n.value===t}},T.find.ID=function(e,t){if("undefined"!=typeof t.getElementById&&L){var n,r,i,o=t.getElementById(e);if(o){if(
...
if("*"===e){for(;n=o[i++];)1===n.nodeType&&r.push(n);return r}return o},T.find.CLASS=j.getElementsByClassName&&function(e,t){if("undefined"!=typeof t.getElementsByClassName&&L)return t.getElementsByClassName(e)},H=[],I=[],(j.qsa=me.test(O.querySelectorAll))&&(i(function(e){
...
// Set document vars if needed
(e.ownerDocument||e)!==O&&A(e);var n=T.attrHandle[t.toLowerCase()],
// Don't get fooled by Object.prototype properties (jQuery #13807)
r=n&&X.call(T.attrHandle,t.toLowerCase())?n(e,t,!L):void 0;return void 0!==r?r:j.attributes||!L?e.getAttribute(t):(r=e.getAttributeNode(t))&&r.specified?r.value:null},t.escape=function(e){return(e+"").replace(xe,je)},t.error=function(e){throw new Error("Syntax error, unrecognized expression: "+e)},/**
...
break}if(u)for(i in r)r.hasOwnProperty(i)&&r[i]===t&&(delete r[i],l=!0)}return l}})}()}),require.register("armorDecorator.js",function(e,t,n){function r(){u("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").not("[data-fate-armor-name]").each(function(e,t){u(this).attr("data-fate-armor-name",u(this).attr("title").split("\n")[0])})}function i(){u("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").not("[data-fate-base-light]").each(function(e,t){var n=parseInt(u(this).children(".item-stat").text().match(/(\d+)/));u(this).attr("data-fate-base-light",n)})}function o(){u("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").not("[data-fate-serial]").each(function(e,t){u(this).attr("data-fate-serial",u(this).attr("id").split("-")[0])})}function a(){u("[drag-channel=Helmet],[drag-channel=Gauntlets],[drag-channel=Chest],[drag-channel=Leg],[drag-channel=ClassItem]").each(function(e,t){var n=u(this).children(".item-img.masterwork").length>0;u(this).attr("data-fate-masterwork",n)})}const s=t("fateBus.js");s.registerModule(n);var u=t("jquery");s.subscribe(n,"fate.refresh",function(){r(),i(),o(),a()})}),require.register("beautification.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n),r.subscribe(n,"fate.init",function(){GM_addStyle(GM_getResourceText("fateOfAllFoolsCSS"))})}),require.register("commentDecorator.js",function(e,t,n){function r(){a.log("commentDecorator.js: Updating tooltips"),o("[data-fate-weapon-registered=true]").each(function(e,t){var n=o(this).attr("data-fate-weapon-name"),r=o(this).attr("data-fate-weapon-type"),i=o(this).attr("data-fate-comment");o(this).attr("title",n+" // "+r+"\n"+i)}),o("[data-fate-shader-registered=true]").each(function(e,t){var n=o(this).attr("data-fate-shader-name"),r=o(this).attr("data-fate-comment");o(this).attr("title",n+"\n"+r)})}const i=t("fateBus.js");i.registerModule(n);var o=t("jquery"),a=t("logger");i.subscribe(n,"fate.refresh",r)}),require.register("configuration.js",function(e,t,n){function r(){s.log("configuration.js: Initializing"),GM_config.init({id:"FateConfig",fields:{weaponListTSV:{label:"Weapon Data Tab-Separated Values",type:"text","default":"https://docs.google.com/spreadsheets/d/e/2PACX-1vQ06pCDSdvu2nQzgHMXl22ci-6pO9rTTmvZmlKXaiBrIHVhl1X1awIaHEOagZcs4ME4X9ZMEghBP9NE/pub?gid=96907753&single=true&output=tsv"},rollDataTSV:{label:"Roll Data Tab-Separated Values",type:"text","default":"https://docs.google.com/spreadsheets/d/e/2PACX-1vQ06pCDSdvu2nQzgHMXl22ci-6pO9rTTmvZmlKXaiBrIHVhl1X1awIaHEOagZcs4ME4X9ZMEghBP9NE/pub?gid=1131147082&single=true&output=tsv"},shaderDataTSV:{label:"Shader Data Tab-Separated Values",type:"text","default":"https://docs.google.com/spreadsheets/d/e/2PACX-1vQ06pCDSdvu2nQzgHMXl22ci-6pO9rTTmvZmlKXaiBrIHVhl1X1awIaHEOagZcs4ME4X9ZMEghBP9NE/pub?gid=1194152043&single=true&output=tsv"}},events:{save:function(){o.subscribe(n,"fate.refresh",r)}}}),o.publish(n,"fate.configurationLoaded",{weaponListTSV:GM_config.get("weaponListTSV"),rollDataTSV:GM_config.get("rollDataTSV"),shaderDataTSV:GM_config.get("shaderDataTSV")})}function i(){a(".fate-config").length>0||(a(".header-links").prepend("<a class='link fate-config'>FATE Config</a>"),a(".fate-config").on("click",function(){GM_config.open()}))}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("logger");o.subscribe(n,"fate.init",r),o.subscribe(n,"fate.refresh",i)}),require.register("dupeIndicator.js",function(e,t,n){function r(){var e=new Map;return l("[data-fate-weapon-name]").each(function(t,n){var r=l(this).attr("data-fate-weapon-name"),i={name:r,domElement:this};e.has(r)?e.set(r,e.get(r).concat(i)):e.set(r,[i])}),e}function i(e){var t=!0,n=!1,r=void 0;try{for(var i,o=function(){var e=c(i.value,2),t=(e[0],e[1]);t.forEach(function(e){if(1===t.length)l(e.domElement).attr("data-fate-weapon-dupe",!1);else{var n="false"===l(e.domElement).attr("data-fate-roll-stored");l(e.domElement).attr("data-fate-weapon-dupe",n)}})},a=e[Symbol.iterator]();!(t=(i=a.next()).done);t=!0)o()}catch(s){n=!0,r=s}finally{try{!t&&a["return"]&&a["return"]()}finally{if(n)throw r}}}function o(){var e=l(this).parent().attr("data-fate-weapon-name");l("[data-fate-weapon-name]").not('[data-fate-weapon-name="'+e+'"]').addClass("fate-search-hidden")}function a(){l(".fate-search-hidden").removeClass("fate-search-hidden")}function s(){l('[data-fate-weapon-dupe="true"] > .'+d.DUPLICATE_INDICATOR_CLASS).on("mouseenter.dupe",o),l('[data-fate-weapon-dupe="true"] > .'+d.DUPLICATE_INDICATOR_CLASS).on("mouseleave.dupe",a)}const u=t("fateBus.js");u.registerModule(n);var c=function(){function e(e,t){var n=[],r=!0,i=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(r=(a=s.next()).done)&&(n.push(a.value),!t||n.length!==t);r=!0);}catch(u){i=!0,o=u}finally{try{!r&&s["return"]&&s["return"]()}finally{if(i)throw o}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),l=t("jquery"),f=t("logger.js"),d=t("indicators.js");u.subscribe(n,"fate.refresh",function(){f.log("dupeIndicator.js: Calculating duplicates"),i(r()),s(),u.publish(n,"fate.dupesCalculated")}),/*
  ...
  events.
*/
u.subscribe(n,"fate.test.mouseenter.dupe",function(e,t){l(t).each(o)}),u.subscribe(n,"fate.test.mouseleave.dupe",function(e,t){l(t).each(a)})}),require.register("fateBus.js",function(e,t,n){"use strict";function r(e){p.set(e.id,!1)}function i(){p.clear()}function o(e){return p.get(e.id)}function a(e,t,n){if(!p.has(e.id))throw new Error("fateBus.js#publish: Module ["+e.id+"] is not defined");o(e)||d.publishSync(t,n)}function s(e,t,n){if(!p.has(e.id))throw new Error("fateBus.js#subscribe: Module ["+e.id+"] is not defined");d.subscribe(t,function(t,r){p.has(e.id)&&(o(e)||n(t,r))})}function u(e){p.set(e,!0)}function c(){var e=Array.from(p.keys());e.forEach(function(e){u(e)})}function l(e){p.set(e,!1)}function f(e){d.unsubscribe(e)}var d=t("pubsub-js"),p=new Map;e.registerModule=r,e.deregisterModules=i,e.publish=a,e.subscribe=s,e.mute=u,e.muteAll=c,e.unmute=l,e.unsubscribeFunctionFromAllTopics=f}),require.register("fodderIndicator.js",function(e,t,n){function r(){f.clear(),c('[data-fate-weapon-registered="true"]').each(function(e,t){
// console.log('  => Examining ' + $(this).attr('data-fate-weapon-name'));
if("true"!==c(this).attr("data-fate-weapon-junk")&&!(c(this).is("[data-fate-weapon-rarity=common]")||c(this).is("[data-fate-weapon-rarity=uncommon]")||c(this).is("[data-fate-weapon-rarity=rare]"))){
// console.log('   => Good weapon!');
var n=c(this).attr("data-fate-weapon-name"),r=c(this).attr("drag-channel"),i=parseInt(c(this).attr("data-fate-base-light")),o={slot:r,light:i,domElement:this,toString:function(){return r+" - "+n+" ("+i+")"}};f.has(r)?f.set(r,f.get(r).concat(o)):f.set(r,[o])}})}function i(e){c("[data-fate-weapon-name]").each(function(e,t){
// console.log('Examining ' + $(this).attr('data-fate-weapon-name'));
if(c(this).is('[data-fate-weapon-registered="false"]'))
// console.log(' => skipping, unregistered');
return void c(this).attr("data-fate-fodder",!1);if(c(this).is('[data-fate-weapon-junk="false"]')&&c(this).is('[data-fate-weapon-dupe="false"]'))
// console.log(' => skipping, not junk and not dupe');
return void c(this).attr("data-fate-fodder",!1);if(c(this).is('[data-fate-weapon-rarity="common"]')||c(this).is('[data-fate-weapon-rarity="uncommon"]'))
// console.log(' => skipping, common or uncommon');
return void c(this).attr("data-fate-fodder",!1);var n=f.get(c(this).attr("drag-channel"));if(void 0===n)
// console.log(' => skipping, no good weapons');
return void c(this).attr("data-fate-fodder",!1);var r=parseInt(c(this).attr("data-fate-base-light"));n.filter(function(e){return e.light<r}).length>0?
// console.log(' => FODDER!');
c(this).attr("data-fate-fodder",!0):
// console.log(' => NOT FODDER!');
c(this).attr("data-fate-fodder",!1)})}function o(){}function a(){c(".fate-search-hidden").removeClass("fate-search-hidden")}function s(){}const u=t("fateBus.js");u.registerModule(n);var c=t("jquery"),l=t("logger.js"),f=(t("indicators.js"),new Map);u.subscribe(n,"fate.infusionCalculated",function(){l.log("fodderIndicator.js: Calculating fodder"),r(),i(),s()}),/*
  jasmine-jquery doesn't seem to play well these days. Not sure why but it can't
  seem to trigger events via $.trigger, so we're going to use our bus to test the
  events.
*/
