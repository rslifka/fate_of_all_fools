...
"use strict";function n(e,t,n){n=n||ue;var r,i,o=n.createElement("script");if(o.text=e,t)for(r in je)
...
// via an object.
i=t[r]||t.getAttribute&&t.getAttribute(r),i&&o.setAttribute(r,i);n.head.appendChild(o).parentNode.removeChild(o)}function r(e){return null==e?e+"":"object"==typeof e||"function"==typeof e?he[ge.call(e)]||"object":typeof e}function i(e){
// Support: real iOS 8.2 only (not reproducible in simulator)
// `in` check used to prevent JIT error (gh-2145)
// hasOwn isn't used here due to false negatives
// regarding Nodelist length in IE
var t=!!e&&"length"in e&&e.length,n=r(e);return!we(e)&&!xe(e)&&("array"===n||0===t||"number"==typeof t&&t>0&&t-1 in e)}function o(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()}
// Implement the identical functionality for filter and not
function a(e,t,n){
// Single element
// Arraylike of elements (jQuery, arguments, Array)
return we(t)?Ce.grep(e,function(e,r){return!!t.call(e,r,e)!==n}):t.nodeType?Ce.grep(e,function(e){return e===t!==n}):"string"!=typeof t?Ce.grep(e,function(e){return pe.call(t,e)>-1!==n}):Ce.filter(t,e,n)}function s(e,t){for(;(e=e[t])&&1!==e.nodeType;);return e}
// Convert String-formatted options into Object-formatted ones
function u(e){var t={};return Ce.each(e.match(Le)||[],function(e,n){t[n]=!0}),t}function c(e){return e}function l(e){throw e}function f(e,t,n,r){var i;try{
// Check for promise aspect first to privilege synchronous behavior
e&&we(i=e.promise)?i.call(e).done(t).fail(n):e&&we(i=e.then)?i.call(e,t,n):
...
function d(){ue.removeEventListener("DOMContentLoaded",d),e.removeEventListener("load",d),Ce.ready()}
// Used by camelCase as callback to replace()
function p(e,t){return t.toUpperCase()}
// Convert dashed to camelCase; used by the css and data modules
// Support: IE <=9 - 11, Edge 12 - 15
// Microsoft forgot to hump their vendor prefix (#9572)
function h(e){return e.replace(Be,"ms-").replace(Fe,p)}function g(){this.expando=Ce.expando+g.uid++}function m(e){
// Only convert to a number if it doesn't change the string
return"true"===e||"false"!==e&&("null"===e?null:e===+e+""?+e:ze.test(e)?JSON.parse(e):e)}function v(e,t,n){var r;
// If nothing was found internally, try to fetch any
// data from the HTML5 data-* attribute
if(void 0===n&&1===e.nodeType)if(r="data-"+t.replace(Ve,"-$&").toLowerCase(),n=e.getAttribute(r),"string"==typeof n){try{n=m(n)}catch(i){}
// Make sure we set the data so it isn't changed later
$e.set(e,t,n)}else n=void 0;return n}function y(e,t,n,r){var i,o,a=20,s=r?function(){return r.cur()}:function(){return Ce.css(e,t,"")},u=s(),c=n&&n[3]||(Ce.cssNumber[t]?"":"px"),
// Starting value computation is required for potential unit mismatches
l=e.nodeType&&(Ce.cssNumber[t]||"px"!==c&&+u)&&Xe.exec(Ce.css(e,t));if(l&&l[3]!==c){for(
// Support: Firefox <=54
...
Ce.style(e,t,l+c),(1-o)*(1-(o=s()/u||.5))<=0&&(a=0),l/=o;l=2*l,Ce.style(e,t,l+c),
// Make sure we update the tween properties later on
n=n||[]}
// Apply relative offset (+=/-=) if specified
return n&&(l=+l||+u||0,i=n[1]?l+(n[1]+1)*n[2]:+n[2],r&&(r.unit=c,r.start=l,r.end=i)),i}function b(e){var t,n=e.ownerDocument,r=e.nodeName,i=tt[r];return i?i:(t=n.body.appendChild(n.createElement(r)),i=Ce.css(t,"display"),t.parentNode.removeChild(t),"none"===i&&(i="block"),tt[r]=i,i)}function w(e,t){
// Determine new display value for elements that need to change
for(var n,r,i=[],o=0,a=e.length;o<a;o++)r=e[o],r.style&&(n=r.style.display,t?(
// Since we force visibility upon cascade-hidden elements, an immediate (and slow)
// check is required in this first loop unless we have a nonempty display value (either
// inline or about-to-be-restored)
"none"===n&&(i[o]=We.get(r,"display")||null,i[o]||(r.style.display="")),""===r.style.display&&Ze(r)&&(i[o]=b(r))):"none"!==n&&(i[o]="none",
// Remember what we're overwriting
We.set(r,"display",n)));
// Set the display of the elements in a second loop to avoid constant reflow
for(o=0;o<a;o++)null!=i[o]&&(e[o].style.display=i[o]);return e}function x(e,t){
// Support: IE <=9 - 11 only
// Use typeof to avoid zero-argument method invocation on host objects (#15151)
var n;return n="undefined"!=typeof e.getElementsByTagName?e.getElementsByTagName(t||"*"):"undefined"!=typeof e.querySelectorAll?e.querySelectorAll(t||"*"):[],void 0===t||t&&o(e,t)?Ce.merge([e],n):n}
// Mark scripts as having already been evaluated
function j(e,t){for(var n=0,r=e.length;n<r;n++)We.set(e[n],"globalEval",!t||We.get(t[n],"globalEval"))}function T(e,t,n,i,o){for(var a,s,u,c,l,f,d=t.createDocumentFragment(),p=[],h=0,g=e.length;h<g;h++)if(a=e[h],a||0===a)
// Add nodes directly
if("object"===r(a))
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
Ce.merge(p,a.nodeType?[a]:a);else if(at.test(a)){for(s=s||d.appendChild(t.createElement("div")),
// Deserialize a standard representation
u=(rt.exec(a)||["",""])[1].toLowerCase(),c=ot[u]||ot._default,s.innerHTML=c[1]+Ce.htmlPrefilter(a)+c[2],
// Descend through wrappers to the right content
f=c[0];f--;)s=s.lastChild;
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
Ce.merge(p,s.childNodes),
...
if(i&&Ce.inArray(a,i)>-1)o&&o.push(a);else
// Capture executables
if(l=Qe(a),
// Append to fragment
s=x(d.appendChild(a),"script"),
// Preserve script evaluation history
l&&j(s),n)for(f=0;a=s[f++];)it.test(a.type||"")&&n.push(a);return d}function C(){return!0}function S(){return!1}
// Support: IE <=9 - 11+
...
function E(e,t){return e===k()==("focus"===t)}
// Support: IE <=9 only
// Accessing document.activeElement can throw unexpectedly
// https://bugs.jquery.com/ticket/13393
function k(){try{return ue.activeElement}catch(e){}}function _(e,t,n,r,i,o){var a,s;
...
i=r,r=void 0):(
// ( types, data, fn )
i=r,r=n,n=void 0)),i===!1)i=S;else if(!i)return e;
// Use same guid so caller can remove using origFn
return 1===o&&(a=i,i=function(e){
// Can use an empty set, since event contains the info
return Ce().off(e),a.apply(this,arguments)},i.guid=a.guid||(a.guid=Ce.guid++)),e.each(function(){Ce.event.add(this,t,i,r,n)})}
...
return n?(We.set(e,t,!1),void Ce.event.add(e,t,{namespace:!1,handler:function(e){var r,i,o=We.get(this,t);if(1&e.isTrigger&&this[t]){
// Interrupt processing of the outer synthetic .trigger()ed event
// Saved data should be false in such cases, but might be a leftover capture object
// from an async native handler (gh-4350)
if(o.length)(Ce.event.special[t]||{}).delegateType&&e.stopPropagation();else if(
// Store arguments for use when handling the inner native event
// There will always be at least one argument (an event object), so this array
// will not be confused with a leftover capture object.
o=le.call(arguments),We.set(this,t,o),
// Trigger the native event and capture its result
// Support: IE <=9 - 11+
// focus() and blur() are asynchronous
r=n(this,t),this[t](),i=We.get(this,t),o!==i||r?We.set(this,t,!1):i={},o!==i)
// Cancel the outer synthetic event
return e.stopImmediatePropagation(),e.preventDefault(),i.value}else o.length&&(
// ...and capture the result
We.set(this,t,{value:Ce.event.trigger(
// Support: IE <=9 - 11+
// Extend with the prototype to reset the above stopImmediatePropagation()
Ce.extend(o[0],Ce.Event.prototype),o.slice(1),this)}),
// Abort handling of the native event
e.stopImmediatePropagation())}})):void(void 0===We.get(e,t)&&Ce.event.add(e,t,C))}
// Prefer a tbody over its parent table for containing new rows
function A(e,t){return o(e,"table")&&o(11!==t.nodeType?t:t.firstChild,"tr")?Ce(e).children("tbody")[0]||e:e}
// Replace/restore the type attribute of script elements for safe DOM manipulation
function N(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function q(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function M(e,t){var n,r,i,o,a,s,u,c;if(1===t.nodeType){
// 1. Copy private data: events, handlers, etc.
if(We.hasData(e)&&(o=We.access(e),a=We.set(t,o),c=o.events)){delete a.handle,a.events={};for(i in c)for(n=0,r=c[i].length;n<r;n++)Ce.event.add(t,i,c[i][n])}
// 2. Copy user data
$e.hasData(e)&&(s=$e.access(e),u=Ce.extend({},s),$e.set(t,u))}}
...
for(s=Ce.map(x(o,"script"),N),u=s.length;f<d;f++)c=o,f!==p&&(c=Ce.clone(c,!0,!0),
// Keep references to cloned scripts for later restoration
u&&
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
Ce.merge(s,x(c,"script"))),r.call(e[f],c,f);if(u)
// Evaluate executable scripts on first document insertion
for(l=s[s.length-1].ownerDocument,
// Reenable scripts
Ce.map(s,q),f=0;f<u;f++)c=s[f],it.test(c.type||"")&&!We.access(c,"globalEval")&&Ce.contains(l,c)&&(c.src&&"module"!==(c.type||"").toLowerCase()?
...
return n=n||gt(e),n&&(a=n.getPropertyValue(t)||n[t],""!==a||Qe(e)||(a=Ce.style(e,t)),!be.pixelBoxStyles()&&ht.test(a)&&mt.test(t)&&(r=s.width,i=s.minWidth,o=s.maxWidth,s.minWidth=s.maxWidth=s.width=a,a=n.width,s.width=r,s.minWidth=i,s.maxWidth=o)),void 0!==a?a+"":a}function I(e,t){
...
var t=e[0].toUpperCase()+e.slice(1),n=vt.length;n--;)if(e=vt[n]+t,e in yt)return e}
// Return a potentially-mapped jQuery.cssProps or vendor prefixed property
function B(e){var t=Ce.cssProps[e]||bt[e];return t?t:e in yt?e:bt[e]=P(e)||e}function F(e,t,n){
...
"margin"===n&&(u+=Ce.css(e,n+Ye[a],!0,i)),
// If we get here with a content-box, we're seeking "padding" or "border" or "margin"
r?(
// For "content", subtract padding
"content"===n&&(u-=Ce.css(e,"padding"+Ye[a],!0,i)),
// For "content" or "padding", subtract border
"margin"!==n&&(u-=Ce.css(e,"border"+Ye[a]+"Width",!0,i))):(
// Add padding
u+=Ce.css(e,"padding"+Ye[a],!0,i),
// For "border" or "margin", add border
"padding"!==n?u+=Ce.css(e,"border"+Ye[a]+"Width",!0,i):s+=Ce.css(e,"border"+Ye[a]+"Width",!0,i));
...
i=!be.boxSizingReliable()||n,o=i&&"border-box"===Ce.css(e,"boxSizing",!1,r),a=o,s=H(e,t,r),u="offset"+t[0].toUpperCase()+t.slice(1);
// Support: Firefox <=54
// Return a confounding non-pixel value or feign ignorance, as appropriate.
if(ht.test(s)){if(!n)return s;s="auto"}
...
return(!be.boxSizingReliable()&&o||"auto"===s||!parseFloat(s)&&"inline"===Ce.css(e,"display",!1,r))&&e.getClientRects().length&&(o="border-box"===Ce.css(e,"boxSizing",!1,r),a=u in e,a&&(s=e[u])),s=parseFloat(s)||0,s+G(e,t,n||(o?"border":"content"),a,r,s)+"px"}function $(e,t,n,r,i){return new $.prototype.init(e,t,n,r,i)}function z(){St&&(ue.hidden===!1&&e.requestAnimationFrame?e.requestAnimationFrame(z):e.setTimeout(z,Ce.fx.interval),Ce.fx.tick())}
// Animations created synchronously will run synchronously
function V(){return e.setTimeout(function(){Ct=void 0}),Ct=Date.now()}
...
return r}function Y(e,t,n){var r,i,o,a,s,u,c,l,f="width"in t||"height"in t,d=this,p={},h=e.style,g=e.nodeType&&Ze(e),m=We.get(e,"fxshow");
// Queue-skipping animations hijack the fx hooks
n.queue||(a=Ce._queueHooks(e,"fx"),null==a.unqueued&&(a.unqueued=0,s=a.empty.fire,a.empty.fire=function(){a.unqueued||s()}),a.unqueued++,d.always(function(){
...
u=!Ce.isEmptyObject(t),u||!Ce.isEmptyObject(p)){
...
c=m&&m.display,null==c&&(c=We.get(e,"display")),l=Ce.css(e,"display"),"none"===l&&(c?l=c:(
// Get nonempty value(s) by temporarily forcing visibility
w([e],!0),c=e.style.display||c,l=Ce.css(e,"display"),w([e]))),
// Animate inline elements as inline-block
("inline"===l||"inline-block"===l&&null!=c)&&"none"===Ce.css(e,"float")&&(
...
u||(m?"hidden"in m&&(g=m.hidden):m=We.access(e,"fxshow",{display:c}),
...
g||w([e]),We.remove(e,"fxshow");for(r in p)Ce.style(e,r,p[r])})),
// Per-property setup
u=X(g?m[r]:0,r,d),r in m||(m[r]=u.start,g&&(u.end=u.start,u.start=0))}}function K(e,t){var n,r,i,o,a;
// camelCase, specialEasing and expand cssHook pass
for(n in e)if(r=h(n),i=t[r],o=e[n],Array.isArray(o)&&(i=o[1],o=e[n]=o[0]),n!==r&&(e[r]=o,delete e[n]),a=Ce.cssHooks[r],a&&"expand"in a){o=a.expand(o),delete e[r];
// Not quite $.extend, this won't overwrite existing keys.
// Reusing 'index' because we have the correct "name"
for(n in o)n in e||(e[n]=o[n],t[n]=i)}else t[r]=i}function Q(e,t,n){var r,i,o=0,a=Q.prefilters.length,s=Ce.Deferred().always(function(){
// Don't match elem in the :animated selector
delete u.elem}),u=function(){if(i)return!1;for(var t=Ct||V(),n=Math.max(0,c.startTime+c.duration-t),
...
return s.notifyWith(e,[c,o,n]),o<1&&u?n:(u||s.notifyWith(e,[c,1,0]),s.resolveWith(e,[c]),!1)},c=s.promise({elem:e,props:Ce.extend({},t),opts:Ce.extend(!0,{specialEasing:{},easing:Ce.easing._default},n),originalProperties:t,originalOptions:n,startTime:Ct||V(),duration:n.duration,tweens:[],createTween:function(t,n){var r=Ce.Tween(e,c.opts,t,n,c.opts.specialEasing[t]||c.opts.easing);return c.tweens.push(r),r},stop:function(t){var n=0,
// If we are going to the end, we want to run all the tweens
// otherwise we skip this part
r=t?c.tweens.length:0;if(i)return this;for(i=!0;n<r;n++)c.tweens[n].run(1);
// Resolve when we played the last frame; otherwise, reject
return t?(s.notifyWith(e,[c,1,0]),s.resolveWith(e,[c,t])):s.rejectWith(e,[c,t]),this}}),l=c.props;for(K(l,c.opts.specialEasing);o<a;o++)if(r=Q.prefilters[o].call(c,e,l,c.opts))return we(r.stop)&&(Ce._queueHooks(c.elem,c.opts.queue).stop=r.stop.bind(r)),r;
// Attach callbacks from options
return Ce.map(l,X,c),we(c.opts.start)&&c.opts.start.call(e,c),c.progress(c.opts.progress).done(c.opts.done,c.opts.complete).fail(c.opts.fail).always(c.opts.always),Ce.fx.timer(Ce.extend(u,{elem:e,anim:c,queue:c.opts.queue})),c}
// Strip and collapse whitespace according to HTML spec
// https://infra.spec.whatwg.org/#strip-and-collapse-ascii-whitespace
function J(e){var t=e.match(Le)||[];return t.join(" ")}function Z(e){return e.getAttribute&&e.getAttribute("class")||""}function ee(e){return Array.isArray(e)?e:"string"==typeof e?e.match(Le)||[]:[]}function te(e,t,n,i){var o;if(Array.isArray(t))
// Serialize array item.
Ce.each(t,function(t,r){n||It.test(e)?
...
return function(t,n){"string"!=typeof t&&(n=t,t="*");var r,i=0,o=t.toLowerCase().match(Le)||[];if(we(n))
// For each dataType in the dataTypeExpression
for(;r=o[i++];)
// Prepend if requested
"+"===r[0]?(r=r.slice(1)||"*",(e[r]=e[r]||[]).unshift(n)):(e[r]=e[r]||[]).push(n)}}
// Base inspection function for prefilters and transports
function re(e,t,n,r){function i(s){var u;return o[s]=!0,Ce.each(e[s]||[],function(e,s){var c=s(t,n,r);return"string"!=typeof c||a||o[c]?a?!(u=c):void 0:(t.dataTypes.unshift(c),i(c),!1)}),u}var o={},a=e===Kt;return i(t.dataTypes[0])||!o["*"]&&i("*")}
// A special extend for ajax options
// that takes "flat" options (not to be deep extended)
// Fixes #9887
function ie(e,t){var n,r,i=Ce.ajaxSettings.flatOptions||{};for(n in t)void 0!==t[n]&&((i[n]?e:r||(r={}))[n]=t[n]);return r&&Ce.extend(!0,e,r),e}/* Handles responses to an ajax request:
...
return"function"==typeof e&&"number"!=typeof e.nodeType},xe=function(e){return null!=e&&e===e.window},je={type:!0,src:!0,nonce:!0,noModule:!0},Te="3.4.1",
...
Se=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;Ce.fn=Ce.prototype={
// The current version of jQuery being used
jquery:Te,constructor:Ce,
...
push:de,sort:se.sort,splice:se.splice},Ce.extend=Ce.fn.extend=function(){var e,t,n,r,i,o,a=arguments[0]||{},s=1,u=arguments.length,c=!1;for(
...
c&&r&&(Ce.isPlainObject(r)||(i=Array.isArray(r)))?(n=a[t],
// Ensure proper type for the source value
o=i&&!Array.isArray(n)?[]:i||Ce.isPlainObject(n)?n:{},i=!1,
// Never move original objects, clone them
a[t]=Ce.extend(c,o,r)):void 0!==r&&(a[t]=r));
...
return!(!e||"[object Object]"!==ge.call(e))&&(!(t=ce(e))||(n=me.call(t,"constructor")&&t.constructor,"function"==typeof n&&ve.call(n)===ye))},isEmptyObject:function(e){var t;for(t in e)return!1;return!0},
// Evaluates a script in a global context
globalEval:function(e,t){n(e,{nonce:t&&t.nonce})},each:function(e,t){var n,r=0;if(i(e))for(n=e.length;r<n&&t.call(e[r],r,e[r])!==!1;r++);else for(r in e)if(t.call(e[r],r,e[r])===!1)break;return e},
// Support: Android <=4.0 only
trim:function(e){return null==e?"":(e+"").replace(Se,"")},
// results is for internal usage only
makeArray:function(e,t){var n=t||[];return null!=e&&(i(Object(e))?Ce.merge(n,"string"==typeof e?[e]:e):de.call(n,e)),n},inArray:function(e,t,n){return null==t?-1:pe.call(t,e,n)},
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
...
if(!r&&((t?t.ownerDocument||t:F)!==M&&q(t),t=t||M,R)){
...
d=we.test(e)&&f(t.parentNode)||t}try{return Z.apply(n,d.querySelectorAll(l)),n}catch(g){U(e,!0)}finally{s===B&&t.removeAttribute("id")}}}
// All others
...
for(c&&(D=a===M||a||c);h!==x&&null!=(l=b[h]);h++){if(o&&l){for(f=0,a||l.ownerDocument===M||(q(l),s=!R);d=e[f++];)if(d(l,a||M,s)){u.push(l);break}c&&(G=w)}
...
return c&&(G=w,D=y),g};return i?r(a):a}var x,j,T,C,S,E,k,_,D,A,N,
// Local document vars
q,M,O,R,L,H,I,P,
// Instance-specific data
B="sizzle"+1*new Date,F=e.document,G=0,W=0,$=n(),z=n(),V=n(),U=n(),X=function(e,t){return e===t&&(N=!0),0},
// Instance methods
...
xe=new RegExp("\\\\([\\da-f]{1,6}"+re+"?|("+re+")|.)","ig"),je=function(e,t,n){var r="0x"+t-65536;
...
// error in IE
Se=function(){q()},Ee=h(function(e){return e.disabled===!0&&"fieldset"===e.nodeName.toLowerCase()},{dir:"parentNode",next:"legend"});
// Optimize for push.apply( _, NodeList )
try{Z.apply(K=ee.call(F.childNodes),F.childNodes),
// Support: Android<4.0
// Detect silently failing push.apply
K[F.childNodes.length].nodeType}catch(ke){Z={apply:K.length?
 ...
 */
S=t.isXML=function(e){var t=e.namespaceURI,n=(e.ownerDocument||e).documentElement;
// Support: IE <=8
...
return r!==M&&9===r.nodeType&&r.documentElement?(M=r,O=M.documentElement,R=!S(M),F!==M&&(n=M.defaultView)&&n.top!==n&&(n.addEventListener?n.addEventListener("unload",Se,!1):n.attachEvent&&n.attachEvent("onunload",Se)),j.attributes=i(function(e){return e.className="i",!e.getAttribute("className")}),j.getElementsByTagName=i(function(e){return e.appendChild(M.createComment("")),!e.getElementsByTagName("*").length}),j.getElementsByClassName=ye.test(M.getElementsByClassName),j.getById=i(function(e){return O.appendChild(e).id=B,!M.getElementsByName||!M.getElementsByName(B).length}),j.getById?(T.filter.ID=function(e){var t=e.replace(xe,je);return function(e){return e.getAttribute("id")===t}},T.find.ID=function(e,t){if("undefined"!=typeof t.getElementById&&R){var n=t.getElementById(e);return n?[n]:[]}}):(T.filter.ID=function(e){var t=e.replace(xe,je);return function(e){var n="undefined"!=typeof e.getAttributeNode&&e.getAttributeNode("id");return n&&n.value===t}},T.find.ID=function(e,t){if("undefined"!=typeof t.getElementById&&R){var n,r,i,o=t.getElementById(e);if(o){if(
...
if("*"===e){for(;n=o[i++];)1===n.nodeType&&r.push(n);return r}return o},T.find.CLASS=j.getElementsByClassName&&function(e,t){if("undefined"!=typeof t.getElementsByClassName&&R)return t.getElementsByClassName(e)},H=[],L=[],(j.qsa=ye.test(M.querySelectorAll))&&(i(function(e){
...
e.querySelectorAll("*,:x"),L.push(",.*:")})),(j.matchesSelector=ye.test(I=O.matches||O.webkitMatchesSelector||O.mozMatchesSelector||O.oMatchesSelector||O.msMatchesSelector))&&i(function(e){
// Check to see if it's possible to do matchesSelector
// on a disconnected node (IE 9)
j.disconnectedMatch=I.call(e,"*"),
// This should fail with an exception
// Gecko does not error, returns false instead
I.call(e,"[s!='']:x"),H.push("!=",ae)}),L=L.length&&new RegExp(L.join("|")),H=H.length&&new RegExp(H.join("|")),t=ye.test(O.compareDocumentPosition),P=t||ye.test(O.contains)?function(e,t){var n=9===e.nodeType?e.documentElement:e,r=t&&t.parentNode;return e===r||!(!r||1!==r.nodeType||!(n.contains?n.contains(r):e.compareDocumentPosition&&16&e.compareDocumentPosition(r)))}:function(e,t){if(t)for(;t=t.parentNode;)if(t===e)return!0;return!1},X=t?function(e,t){
...
return n?n:(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1,1&n||!j.sortDetached&&t.compareDocumentPosition(e)===n?e===M||e.ownerDocument===F&&P(F,e)?-1:t===M||t.ownerDocument===F&&P(F,t)?1:A?te(A,e)-te(A,t):0:4&n?-1:1)}:function(e,t){
// Exit early if the nodes are identical
if(e===t)return N=!0,0;var n,r=0,i=e.parentNode,o=t.parentNode,s=[e],u=[t];
// Parentless nodes are either documents or disconnected
if(!i||!o)return e===M?-1:t===M?1:i?-1:o?1:A?te(A,e)-te(A,t):0;if(i===o)return a(e,t);for(
...
return r?a(s[r],u[r]):s[r]===F?-1:u[r]===F?1:0},M):M},t.matches=function(e,n){return t(e,null,null,n)},t.matchesSelector=function(e,n){if(
// Set document vars if needed
(e.ownerDocument||e)!==M&&q(e),j.matchesSelector&&R&&!U[n+" "]&&(!H||!H.test(n))&&(!L||!L.test(n)))try{var r=I.call(e,n);
// IE 9's matchesSelector returns false on disconnected nodes
if(r||j.disconnectedMatch||
// As well, disconnected nodes are said to be in a document
// fragment in IE 9
e.document&&11!==e.document.nodeType)return r}catch(i){U(n,!0)}return t(n,M,null,[e]).length>0},t.contains=function(e,t){
// Set document vars if needed
return(e.ownerDocument||e)!==M&&q(e),P(e,t)},t.attr=function(e,t){
// Set document vars if needed
(e.ownerDocument||e)!==M&&q(e);var n=T.attrHandle[t.toLowerCase()],
...
return e[1]=e[1].replace(xe,je),e[3]=(e[3]||e[4]||e[5]||"").replace(xe,je),"~="===e[2]&&(e[3]=" "+e[3]+" "),e.slice(0,4)},CHILD:function(e){/* matches from matchExpr["CHILD"]
				1 type (only|nth|...)
...
var t=[],n=[],i=k(e.replace(ue,"$1"));return i[B]?r(function(e,t,n,r){
// Match elements unmatched by `matcher`
for(var o,a=i(e,null,r,[]),s=e.length;s--;)(o=a[s])&&(e[s]=!(t[s]=o))}):function(e,r,o){
// Don't keep the element (issue #299)
return t[0]=e,i(t,null,o,n),t[0]=null,!n.pop()}}),has:r(function(e){return function(n){return t(e,n).length>0}}),contains:r(function(e){return e=e.replace(xe,je),function(t){return(t.textContent||C(t)).indexOf(e)>-1}}),
...
return d.prototype=T.filters=T.pseudos,T.setFilters=new d,E=t.tokenize=function(e,n){var r,i,o,a,s,u,c,l=z[e+" "];if(l)return n?0:l.slice(0);for(s=e,u=[],c=T.preFilter;s;){
// Comma and first run
r&&!(i=ce.exec(s))||(i&&(
...
// Cache the tokens
return n?s.length:s?t.error(e):z(e,u).slice(0)},k=t.compile=function(e,t){var n,r=[],i=[],o=V[e+" "];if(!o){for(
...
o=l[0]=l[0].slice(0),o.length>2&&"ID"===(a=o[0]).type&&9===t.nodeType&&R&&T.relative[o[1].type]){if(t=(T.find.ID(a.matches[0].replace(xe,je),t)||[])[0],!t)return n;c&&(t=t.parentNode),e=e.slice(o.shift().value.length)}for(
...
return(c||k(e,l))(r,t,!R,n,!t||we.test(e)&&f(t.parentNode)||t),n},j.sortStable=B.split("").sort(X).join("")===B,j.detectDuplicates=!!N,q(),j.sortDetached=i(function(e){
...
qe=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,Me=Ce.fn.init=function(e,t,n){var r,i;
...
Ce.merge(this,Ce.parseHTML(r[1],t&&t.nodeType?t.ownerDocument||t:ue,!0)),Ae.test(r[1])&&Ce.isPlainObject(t))for(r in t)
// Properties of context are called as methods if possible
we(this[r])?this[r](t[r]):this.attr(r,t[r]);return this}
...
Ne=Ce(ue);var Oe=/^(?:parents|prev(?:Until|All))/,
// Methods guaranteed to produce a unique set when starting from a unique set
Re={children:!0,contents:!0,next:!0,prev:!0};Ce.fn.extend({has:function(e){var t=Ce(e,this),n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(Ce.contains(this,t[e]))return!0})},closest:function(e,t){var n,r=0,i=this.length,o=[],a="string"!=typeof e&&Ce(e);
// Positional selectors never match, since there's no _selection_ context
if(!De.test(e))for(;r<i;r++)for(n=this[r];n&&n!==t;n=n.parentNode)
...
return e?"string"==typeof e?pe.call(Ce(e),this[0]):pe.call(this,e.jquery?e[0]:e):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(e,t){return this.pushStack(Ce.uniqueSort(Ce.merge(this.get(),Ce(e,t))))},addBack:function(e){return this.add(null==e?this.prevObject:this.prevObject.filter(e))}}),Ce.each({parent:function(e){var t=e.parentNode;return t&&11!==t.nodeType?t:null},parents:function(e){return ke(e,"parentNode")},parentsUntil:function(e,t,n){return ke(e,"parentNode",n)},next:function(e){return s(e,"nextSibling")},prev:function(e){return s(e,"previousSibling")},nextAll:function(e){return ke(e,"nextSibling")},prevAll:function(e){return ke(e,"previousSibling")},nextUntil:function(e,t,n){return ke(e,"nextSibling",n)},prevUntil:function(e,t,n){return ke(e,"previousSibling",n)},siblings:function(e){return _e((e.parentNode||{}).firstChild,e)},children:function(e){return _e(e.firstChild)},contents:function(e){
// Support: IE 9 - 11 only, iOS 7 only, Android Browser <=4.3 only
// Treat the template element as a regular one in browsers that
// don't support it.
return"undefined"!=typeof e.contentDocument?e.contentDocument:(o(e,"template")&&(e=e.content||e),Ce.merge([],e.childNodes))}},function(e,t){Ce.fn[e]=function(n,r){var i=Ce.map(this,t,n);
// Remove duplicates
// Reverse order for parents* and prev-derivatives
return"Until"!==e.slice(-5)&&(r=n),r&&"string"==typeof r&&(i=Ce.filter(r,i)),this.length>1&&(Re[e]||Ce.uniqueSort(i),Oe.test(e)&&i.reverse()),this.pushStack(i)}});var Le=/[^\x20\t\r\n\f]+/g;/*
...
e="string"==typeof e?u(e):Ce.extend({},e);var// Flag to know if list is currently firing
t,
...
return a&&(n&&!t&&(c=a.length-1,s.push(n)),function i(t){Ce.each(t,function(t,n){we(n)?e.unique&&f.has(n)||a.push(n):n&&n.length&&"string"!==r(n)&&
// Inspect recursively
i(n)})}(arguments),n&&!t&&l()),this},
// Remove a callback from the list
remove:function(){return Ce.each(arguments,function(e,t){for(var n;(n=Ce.inArray(t,a,n))>-1;)a.splice(n,1),
// Handle firing indexes
n<=c&&c--}),this},
// Check if a given callback is in the list.
// If no argument is given, return whether or not list has callbacks attached.
has:function(e){return e?Ce.inArray(e,a)>-1:a.length>0},
...
fired:function(){return!!i}};return f},Ce.extend({Deferred:function(t){var n=[
...
pipe:function(){var e=arguments;return Ce.Deferred(function(t){Ce.each(n,function(n,r){
// Map tuples (progress, done, fail) to arguments (done, fail, progress)
var i=we(e[r[4]])&&e[r[4]];
// deferred.progress(function() { bind to newDefer or newDefer.notify })
// deferred.done(function() { bind to newDefer or newDefer.resolve })
// deferred.fail(function() { bind to newDefer or newDefer.reject })
o[r[1]](function(){var e=i&&i.apply(this,arguments);e&&we(e.promise)?e.promise().progress(t.notify).done(t.resolve).fail(t.reject):t[r[0]+"With"](this,i?[e]:arguments)})}),e=null}).promise()},then:function(t,r,i){function o(t,n,r,i){return function(){var s=this,u=arguments,f=function(){var e,f;
...
d=i?f:function(){try{f()}catch(e){Ce.Deferred.exceptionHook&&Ce.Deferred.exceptionHook(e,d.stackTrace),
...
Ce.Deferred.getStackHook&&(d.stackTrace=Ce.Deferred.getStackHook()),e.setTimeout(d))}}var a=0;return Ce.Deferred(function(e){
// progress_handlers.add( ... )
n[0][3].add(o(0,e,we(i)?i:c,e.notifyWith)),
// fulfilled_handlers.add( ... )
n[1][3].add(o(0,e,we(t)?t:c)),
// rejected_handlers.add( ... )
n[2][3].add(o(0,e,we(r)?r:l))}).promise()},
...
return Ce.each(n,function(e,t){var a=t[2],s=t[5];
...
var He=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;Ce.Deferred.exceptionHook=function(t,n){
// Support: IE 8 - 9 only
// Console exists when dev tools are open, which can happen at any time
e.console&&e.console.warn&&t&&He.test(t.name)&&e.console.warn("jQuery.Deferred exception: "+t.message,t.stack,n)},Ce.readyException=function(t){e.setTimeout(function(){throw t})};
// The deferred used on DOM ready
var Ie=Ce.Deferred();Ce.fn.ready=function(e){return Ie.then(e)["catch"](function(e){Ce.readyException(e)}),this},Ce.extend({
...
Ie.resolveWith(ue,[Ce]))}}),Ce.ready.then=Ie.then,
...
// Sets many values
if("object"===r(n)){o=!0;for(u in n)Pe(e,t,u,n[u],!0,a,s)}else if(void 0!==i&&(o=!0,we(i)||(s=!0),l&&(
// Bulk operations run against the entire set
s?(t.call(e,i),t=null):(l=t,t=function(e,t,n){return l.call(Ce(e),n)})),t))for(;u<c;u++)t(e[u],n,s?i:i.call(e[u],u,t(e[u],n)));
// Gets
return o?e:l?t.call(e):c?t(e[0],n):a},Be=/^-ms-/,Fe=/-([a-z])/g,Ge=function(e){
// Accepts only:
//  - Node
//    - Node.ELEMENT_NODE
//    - Node.DOCUMENT_NODE
...
return t||(t={},Ge(e)&&(e.nodeType?e[this.expando]=t:Object.defineProperty(e,this.expando,{value:t,configurable:!0}))),t},set:function(e,t,n){var r,i=this.cache(e);
...
t=t in r?[t]:t.match(Le)||[]),n=t.length;for(;n--;)delete r[t[n]]}
...
e.nodeType?e[this.expando]=void 0:delete e[this.expando])}},hasData:function(e){var t=e[this.expando];return void 0!==t&&!Ce.isEmptyObject(t)}};var We=new g,$e=new g,ze=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Ve=/[A-Z]/g;Ce.extend({hasData:function(e){return $e.hasData(e)||We.hasData(e)},data:function(e,t,n){return $e.access(e,t,n)},removeData:function(e,t){$e.remove(e,t)},
// TODO: Now that all calls to _data and _removeData have been replaced
// with direct calls to dataPriv methods, these can be deprecated.
_data:function(e,t,n){return We.access(e,t,n)},_removeData:function(e,t){We.remove(e,t)}}),Ce.fn.extend({data:function(e,t){var n,r,i,o=this[0],a=o&&o.attributes;
// Gets all values
if(void 0===e){if(this.length&&(i=$e.get(o),1===o.nodeType&&!We.get(o,"hasDataAttrs"))){for(n=a.length;n--;)
// Support: IE 11 only
// The attrs elements can be null (#14894)
a[n]&&(r=a[n].name,0===r.indexOf("data-")&&(r=h(r.slice(5)),v(o,r,i[r])));We.set(o,"hasDataAttrs",!0)}return i}
// Sets multiple values
// Sets multiple values
return"object"==typeof e?this.each(function(){$e.set(this,e)}):Pe(this,function(t){var n;
...
n=$e.get(o,e),void 0!==n)return n;if(
...
$e.set(this,e,t)})},null,t,arguments.length>1,null,!0)},removeData:function(e){return this.each(function(){$e.remove(this,e)})}}),Ce.extend({queue:function(e,t,n){var r;if(e)
// Speed up dequeue by getting out quickly if this is just a lookup
return t=(t||"fx")+"queue",r=We.get(e,t),n&&(!r||Array.isArray(n)?r=We.access(e,t,Ce.makeArray(n)):r.push(n)),r||[]},dequeue:function(e,t){t=t||"fx";var n=Ce.queue(e,t),r=n.length,i=n.shift(),o=Ce._queueHooks(e,t),a=function(){Ce.dequeue(e,t)};
...
_queueHooks:function(e,t){var n=t+"queueHooks";return We.get(e,n)||We.access(e,n,{empty:Ce.Callbacks("once memory").add(function(){We.remove(e,[t+"queue",n])})})}}),Ce.fn.extend({queue:function(e,t){var n=2;return"string"!=typeof e&&(t=e,e="fx",n--),arguments.length<n?Ce.queue(this[0],e):void 0===t?this:this.each(function(){var n=Ce.queue(this,e,t);
...
promise:function(e,t){var n,r=1,i=Ce.Deferred(),o=this,a=this.length,s=function(){--r||i.resolveWith(o,[o])};for("string"!=typeof e&&(t=e,e=void 0),e=e||"fx";a--;)n=We.get(o[a],e+"queueHooks"),n&&n.empty&&(r++,n.empty.add(s));return s(),i.promise(t)}});var Ue=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Xe=new RegExp("^(?:([+-])=|)("+Ue+")([a-z%]*)$","i"),Ye=["Top","Right","Bottom","Left"],Ke=ue.documentElement,Qe=function(e){return Ce.contains(e.ownerDocument,e)},Je={composed:!0};
// Support: IE 9 - 11+, Edge 12 - 18+, iOS 10.0 - 10.2 only
// Check attachment across shadow DOM boundaries when possible (gh-3504)
// Support: iOS 10.0-10.2 only
// Early iOS 10 versions support `attachShadow` but not `getRootNode`,
// leading to errors. We need to check for `getRootNode`.
Ke.getRootNode&&(Qe=function(e){return Ce.contains(e.ownerDocument,e)||e.getRootNode(Je)===e.ownerDocument});var Ze=function(e,t){
...
// in the document.
return e=t||e,"none"===e.style.display||""===e.style.display&&Qe(e)&&"none"===Ce.css(e,"display")},et=function(e,t,n,r){var i,o,a={};
// Remember the old values, and insert the new ones
for(o in t)a[o]=e.style[o],e.style[o]=t[o];i=n.apply(e,r||[]);
// Revert the old values
for(o in t)e.style[o]=a[o];return i},tt={};Ce.fn.extend({show:function(){return w(this,!0)},hide:function(){return w(this)},toggle:function(e){return"boolean"==typeof e?e?this.show():this.hide():this.each(function(){Ze(this)?Ce(this).show():Ce(this).hide()})}});var nt=/^(?:checkbox|radio)$/i,rt=/<([a-z][^\/\0>\x20\t\r\n\f]*)/i,it=/^$|^module$|\/(?:java|ecma)script/i,ot={
// Support: IE <=9 only
...
// Support: IE <=9 only
ot.optgroup=ot.option,ot.tbody=ot.tfoot=ot.colgroup=ot.caption=ot.thead,ot.th=ot.td;var at=/<|&#?\w+;/;!function(){var e=ue.createDocumentFragment(),t=e.appendChild(ue.createElement("div")),n=ue.createElement("input");
...
t.innerHTML="<textarea>x</textarea>",be.noCloneChecked=!!t.cloneNode(!0).lastChild.defaultValue}();var st=/^key/,ut=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,ct=/^([^.]*)(?:\.(.+)|)/;/*
 * Helper functions for managing events -- not part of the public interface.
 * Props to Dean Edwards' addEvent library for many of the ideas.
 */
Ce.event={global:{},add:function(e,t,n,r,i){var o,a,s,u,c,l,f,d,p,h,g,m=We.get(e);
...
i&&Ce.find.matchesSelector(Ke,i),
...
l=Ce.extend({type:p,origType:g,data:r,handler:n,guid:n.guid,selector:i,needsContext:i&&Ce.expr.match.needsContext.test(i),namespace:h.join(".")},o),
...
remove:function(e,t,n,r,i){var o,a,s,u,c,l,f,d,p,h,g,m=We.hasData(e)&&We.get(e);if(m&&(u=m.events)){for(
// Once for each type.namespace in types; type may be omitted
t=(t||"").match(Le)||[""],c=t.length;c--;)
// Unbind all events (on this namespace, if provided) for the element
if(s=ct.exec(t[c])||[],p=g=s[1],h=(s[2]||"").split(".").sort(),p){for(f=Ce.event.special[p]||{},p=(r?f.delegateType:f.bindType)||p,d=u[p]||[],s=s[2]&&new RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"),
...
a&&!d.length&&(f.teardown&&f.teardown.call(e,h,m.handle)!==!1||Ce.removeEvent(e,p,m.handle),delete u[p])}else for(p in u)Ce.event.remove(e,p+t[c],n,r,!0);
// Remove data and the expando if it's no longer used
Ce.isEmptyObject(u)&&We.remove(e,"handle events")}},dispatch:function(e){
// Make a writable jQuery.Event from the native event object
var t,n,r,i,o,a,s=Ce.event.fix(e),u=new Array(arguments.length),c=(We.get(this,"events")||{})[s.type]||[],l=Ce.event.special[s.type]||{};for(
...
// Determine handlers
a=Ce.event.handlers.call(this,s,c),
...
s.rnamespace&&o.namespace!==!1&&!s.rnamespace.test(o.namespace)||(s.handleObj=o,s.data=o.data,r=((Ce.event.special[o.origType]||{}).handle||o.handler).apply(i.elem,u),void 0!==r&&(s.result=r)===!1&&(s.preventDefault(),s.stopPropagation()));
...
i=r.selector+" ",void 0===a[i]&&(a[i]=r.needsContext?Ce(i,this).index(c)>-1:Ce.find(i,this,null,[c]).length),a[i]&&o.push(r);o.length&&s.push({elem:c,handlers:o})}
// Add the remaining (directly-bound) handlers
return c=this,u<t.length&&s.push({elem:c,handlers:t.slice(u)}),s},addProp:function(e,t){Object.defineProperty(Ce.Event.prototype,e,{enumerable:!0,configurable:!0,get:we(t)?function(){if(this.originalEvent)return t(this.originalEvent)}:function(){if(this.originalEvent)return this.originalEvent[e]},set:function(t){Object.defineProperty(this,e,{enumerable:!0,configurable:!0,writable:!0,value:t})}})},fix:function(e){return e[Ce.expando]?e:new Ce.Event(e)},special:{load:{
...
return nt.test(t.type)&&t.click&&o(t,"input")&&D(t,"click",C),!1},trigger:function(e){
// For mutual compressibility with _default, replace `this` access with a local var.
// `|| data` is dead code meant only to preserve the variable through minification.
var t=this||e;
...
_default:function(e){var t=e.target;return nt.test(t.type)&&t.click&&o(t,"input")&&We.get(t,"click")||o(t,"a")}},beforeunload:{postDispatch:function(e){
// Support: Firefox 20+
...
Ce.each({altKey:!0,bubbles:!0,cancelable:!0,changedTouches:!0,ctrlKey:!0,detail:!0,eventPhase:!0,metaKey:!0,pageX:!0,pageY:!0,shiftKey:!0,view:!0,"char":!0,code:!0,charCode:!0,key:!0,keyCode:!0,button:!0,buttons:!0,clientX:!0,clientY:!0,offsetX:!0,offsetY:!0,pointerId:!0,pointerType:!0,screenX:!0,screenY:!0,targetTouches:!0,toElement:!0,touches:!0,which:function(e){var t=e.button;
// Add which for key events
// Add which for key events
// Add which for click: 1 === left; 2 === middle; 3 === right
return null==e.which&&st.test(e.type)?null!=e.charCode?e.charCode:e.keyCode:!e.which&&void 0!==t&&ut.test(e.type)?1&t?1:2&t?3:4&t?2:0:e.which}},Ce.event.addProp),Ce.each({focus:"focusin",blur:"focusout"},function(e,t){Ce.event.special[e]={
...
return i&&(i===r||Ce.contains(r,i))||(e.type=o.origType,n=o.handler.apply(this,arguments),e.type=t),n}}}),Ce.fn.extend({on:function(e,t,n,r){return _(this,e,t,n,r)},one:function(e,t,n,r){return _(this,e,t,n,r,1)},off:function(e,t,n){var r,i;if(e&&e.preventDefault&&e.handleObj)
...
// ( types [, fn] )
return t!==!1&&"function"!=typeof t||(n=t,t=void 0),n===!1&&(n=S),this.each(function(){Ce.event.remove(this,e,n,t)})}});var/* eslint-disable max-len */
...
dt=/checked\s*(?:[^=]|=\s*.checked.)/i,pt=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;Ce.extend({htmlPrefilter:function(e){return e.replace(lt,"<$1></$2>")},clone:function(e,t,n){var r,i,o,a,s=e.cloneNode(!0),u=Qe(e);
// Fix IE cloning issues
if(!(be.noCloneChecked||1!==e.nodeType&&11!==e.nodeType||Ce.isXMLDoc(e)))for(
// We eschew Sizzle here for performance reasons: https://jsperf.com/getall-vs-sizzle/2
a=x(s),o=x(e),r=0,i=o.length;r<i;r++)O(o[r],a[r]);
// Copy the events from the original to the clone
if(t)if(n)for(o=o||x(e),a=a||x(s),r=0,i=o.length;r<i;r++)M(o[r],a[r]);else M(e,s);
// Return the cloned set
// Preserve script evaluation history
return a=x(s,"script"),a.length>0&&j(a,!u&&x(e,"script")),s},cleanData:function(e){for(var t,n,r,i=Ce.event.special,o=0;void 0!==(n=e[o]);o++)if(Ge(n)){if(t=n[We.expando]){if(t.events)for(r in t.events)i[r]?Ce.event.remove(n,r):Ce.removeEvent(n,r,t.handle);
// Support: Chrome <=35 - 45+
// Assign undefined instead of using delete, see Data#remove
n[We.expando]=void 0}n[$e.expando]&&(
// Support: Chrome <=35 - 45+
// Assign undefined instead of using delete, see Data#remove
n[$e.expando]=void 0)}}}),Ce.fn.extend({detach:function(e){return L(this,e,!0)},remove:function(e){return L(this,e)},text:function(e){return Pe(this,function(e){return void 0===e?Ce.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=e)})},null,e,arguments.length)},append:function(){return R(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=A(this,e);t.appendChild(e)}})},prepend:function(){return R(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=A(this,e);t.insertBefore(e,t.firstChild)}})},before:function(){return R(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this)})},after:function(){return R(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this.nextSibling)})},empty:function(){for(var e,t=0;null!=(e=this[t]);t++)1===e.nodeType&&(
// Prevent memory leaks
Ce.cleanData(x(e,!1)),
// Remove any remaining nodes
e.textContent="");return this},clone:function(e,t){return e=null!=e&&e,t=null==t?e:t,this.map(function(){return Ce.clone(this,e,t)})},html:function(e){return Pe(this,function(e){var t=this[0]||{},n=0,r=this.length;if(void 0===e&&1===t.nodeType)return t.innerHTML;
// See if we can take a shortcut and just use innerHTML
if("string"==typeof e&&!ft.test(e)&&!ot[(rt.exec(e)||["",""])[1].toLowerCase()]){e=Ce.htmlPrefilter(e);try{for(;n<r;n++)t=this[n]||{},
// Remove element nodes and prevent memory leaks
1===t.nodeType&&(Ce.cleanData(x(t,!1)),t.innerHTML=e);t=0}catch(i){}}t&&this.empty().append(e)},null,e,arguments.length)},replaceWith:function(){var e=[];
// Make the changes, replacing each non-ignored context element with the new content
return R(this,arguments,function(t){var n=this.parentNode;Ce.inArray(this,e)<0&&(Ce.cleanData(x(this)),n&&n.replaceChild(t,this))},e)}}),Ce.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(e,t){Ce.fn[e]=function(e){for(var n,r=[],i=Ce(e),o=i.length-1,a=0;a<=o;a++)n=a===o?this:this.clone(!0),Ce(i[a])[t](n),
// Support: Android <=4.0 only, PhantomJS 1 only
// .get() because push.apply(_, arraylike) throws on ancient WebKit
de.apply(r,n.get());return this.pushStack(r)}});var ht=new RegExp("^("+Ue+")(?!px)[a-z%]+$","i"),gt=function(t){
// Support: IE <=11 only, Firefox <=30 (#15098, #14150)
// IE throws on elements created in popups
// FF meanwhile throws on frame elements through "defaultView.getComputedStyle"
var n=t.ownerDocument.defaultView;return n&&n.opener||(n=e),n.getComputedStyle(t)},mt=new RegExp(Ye.join("|"),"i");!function(){
// Executing both pixelPosition & boxSizingReliable tests require only one layout
// so they're executed at the same time to save the second computation.
function t(){
// This is a singleton, we need to execute it only once
if(c){u.style.cssText="position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",c.style.cssText="position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%",Ke.appendChild(u).appendChild(c);var t=e.getComputedStyle(c);r="1%"!==t.top,
// Support: Android 4.0 - 4.3 only, Firefox <=3 - 44
s=12===n(t.marginLeft),
// Support: Android 4.0 - 4.3 only, Safari <=9.1 - 10.1, iOS <=7.0 - 9.3
// Some styles come back with percentage values, even though they shouldn't
c.style.right="60%",a=36===n(t.right),
// Support: IE 9 - 11 only
...
c.style.position="absolute",o=12===n(c.offsetWidth/3),Ke.removeChild(u),
// Nullify the div so it wouldn't be stored in the memory and
// it will also be a sign that checks already performed
c=null}}function n(e){return Math.round(parseFloat(e))}var r,i,o,a,s,u=ue.createElement("div"),c=ue.createElement("div");
// Finish early in limited (non-browser) environments
c.style&&(
// Support: IE <=9 - 11 only
// Style of cloned element affects source element cloned (#8908)
c.style.backgroundClip="content-box",c.cloneNode(!0).style.backgroundClip="",be.clearCloneStyle="content-box"===c.style.backgroundClip,Ce.extend(be,{boxSizingReliable:function(){return t(),i},pixelBoxStyles:function(){return t(),a},pixelPosition:function(){return t(),r},reliableMarginLeft:function(){return t(),s},scrollboxSize:function(){return t(),o}}))}();var vt=["Webkit","Moz","ms"],yt=ue.createElement("div").style,bt={},
// Swappable if display is none or starts with table
// except "table", "table-cell", or "table-caption"
// See here for display values: https://developer.mozilla.org/en-US/docs/CSS/display
wt=/^(none|table(?!-c[ea]).+)/,xt=/^--/,jt={position:"absolute",visibility:"hidden",display:"block"},Tt={letterSpacing:"0",fontWeight:"400"};Ce.extend({
...
var i,o,a,s=h(t),u=xt.test(t),c=e.style;
...
return u||(t=B(s)),a=Ce.cssHooks[t]||Ce.cssHooks[s],void 0===n?a&&"get"in a&&void 0!==(i=a.get(e,!1,r))?i:c[t]:(o=typeof n,"string"===o&&(i=Xe.exec(n))&&i[1]&&(n=y(e,t,i),o="number"),null!=n&&n===n&&("number"!==o||u||(n+=i&&i[3]||(Ce.cssNumber[s]?"":"px")),be.clearCloneStyle||""!==n||0!==t.indexOf("background")||(c[t]="inherit"),a&&"set"in a&&void 0===(n=a.set(e,n,r))||(u?c.setProperty(t,n):c[t]=n)),void 0)}},css:function(e,t,n,r){var i,o,a,s=h(t),u=xt.test(t);
...
// Make numeric if forced or a qualifier was provided and val looks numeric
return u||(t=B(s)),a=Ce.cssHooks[t]||Ce.cssHooks[s],a&&"get"in a&&(i=a.get(e,!0,n)),void 0===i&&(i=H(e,t,r)),"normal"===i&&t in Tt&&(i=Tt[t]),""===n||n?(o=parseFloat(i),n===!0||isFinite(o)?o||0:i):i}}),Ce.each(["height","width"],function(e,t){Ce.cssHooks[t]={get:function(e,n,r){if(n)
...
$.propHooks.scrollTop=$.propHooks.scrollLeft={set:function(e){e.elem.nodeType&&e.elem.parentNode&&(e.elem[e.prop]=e.now)}},Ce.easing={linear:function(e){return e},swing:function(e){return.5-Math.cos(e*Math.PI)/2},_default:"swing"},Ce.fx=$.prototype.init,
// Back compat <1.8 extension point
Ce.fx.step={};var Ct,St,Et=/^(?:toggle|show|hide)$/,kt=/queueHooks$/;Ce.Animation=Ce.extend(Q,{tweeners:{"*":[function(e,t){var n=this.createTween(e,t);return y(n.elem,e,Xe.exec(t),n),n}]},tweener:function(e,t){we(e)?(t=e,e=["*"]):e=e.match(Le);for(var n,r=0,i=e.length;r<i;r++)n=e[r],Q.tweeners[n]=Q.tweeners[n]||[],Q.tweeners[n].unshift(t)},prefilters:[Y],prefilter:function(e,t){t?Q.prefilters.unshift(e):Q.prefilters.push(e)}}),Ce.speed=function(e,t,n){var r=e&&"object"==typeof e?Ce.extend({},e):{complete:n||!n&&t||we(e)&&e,duration:e,easing:n&&t||t&&!we(t)&&t};
// Go to the end state if fx are off
// Normalize opt.queue - true/undefined/null -> "fx"
// Queueing
return Ce.fx.off?r.duration=0:"number"!=typeof r.duration&&(r.duration in Ce.fx.speeds?r.duration=Ce.fx.speeds[r.duration]:r.duration=Ce.fx.speeds._default),null!=r.queue&&r.queue!==!0||(r.queue="fx"),r.old=r.complete,r.complete=function(){we(r.old)&&r.old.call(this),r.queue&&Ce.dequeue(this,r.queue)},r},Ce.fn.extend({fadeTo:function(e,t,n,r){
// Show any hidden elements after setting opacity to 0
return this.filter(Ze).css("opacity",0).show().end().animate({opacity:t},e,n,r)},animate:function(e,t,n,r){var i=Ce.isEmptyObject(e),o=Ce.speed(t,n,r),a=function(){
// Operate on a copy of prop so per-property easing won't be lost
var t=Q(this,Ce.extend({},e),o);
// Empty animations, or finishing resolves immediately
(i||We.get(this,"finish"))&&t.stop(!0)};return a.finish=a,i||o.queue===!1?this.each(a):this.queue(o.queue,a)},stop:function(e,t,n){var r=function(e){var t=e.stop;delete e.stop,t(n)};return"string"!=typeof e&&(n=t,t=e,e=void 0),t&&e!==!1&&this.queue(e||"fx",[]),this.each(function(){var t=!0,i=null!=e&&e+"queueHooks",o=Ce.timers,a=We.get(this);if(i)a[i]&&a[i].stop&&r(a[i]);else for(i in a)a[i]&&a[i].stop&&kt.test(i)&&r(a[i]);for(i=o.length;i--;)o[i].elem!==this||null!=e&&o[i].queue!==e||(o[i].anim.stop(n),t=!1,o.splice(i,1));
// Start the next in the queue if the last step wasn't forced.
// Timers currently will call their complete callbacks, which
// will dequeue but only if they were gotoEnd.
!t&&n||Ce.dequeue(this,e)})},finish:function(e){return e!==!1&&(e=e||"fx"),this.each(function(){var t,n=We.get(this),r=n[e+"queue"],i=n[e+"queueHooks"],o=Ce.timers,a=r?r.length:0;
...
delete n.finish})}}),Ce.each(["toggle","show","hide"],function(e,t){var n=Ce.fn[t];Ce.fn[t]=function(e,r,i){return null==e||"boolean"==typeof e?n.apply(this,arguments):this.animate(U(t,!0),e,r,i)}}),
// Generate shortcuts for custom animations
Ce.each({slideDown:U("show"),slideUp:U("hide"),slideToggle:U("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(e,t){Ce.fn[e]=function(e,n,r){return this.animate(t,e,n,r)}}),Ce.timers=[],Ce.fx.tick=function(){var e,t=0,n=Ce.timers;for(Ct=Date.now();t<n.length;t++)e=n[t],
// Run the timer and safely remove it when done (allowing for external removal)
e()||n[t]!==e||n.splice(t--,1);n.length||Ce.fx.stop(),Ct=void 0},Ce.fx.timer=function(e){Ce.timers.push(e),Ce.fx.start()},Ce.fx.interval=13,Ce.fx.start=function(){St||(St=!0,z())},Ce.fx.stop=function(){St=null},Ce.fx.speeds={slow:600,fast:200,
// Default speed
_default:400},
// Based off of the plugin by Clint Helfers, with permission.
// https://web.archive.org/web/20100324014747/http://blindsignals.com/index.php/2009/07/jquery-delay/
Ce.fn.delay=function(t,n){return t=Ce.fx?Ce.fx.speeds[t]||t:t,n=n||"fx",this.queue(n,function(n,r){var i=e.setTimeout(n,t);r.stop=function(){e.clearTimeout(i)}})},function(){var e=ue.createElement("input"),t=ue.createElement("select"),n=t.appendChild(ue.createElement("option"));e.type="checkbox",
...
e=ue.createElement("input"),e.value="t",e.type="radio",be.radioValue="t"===e.value}();var _t,Dt=Ce.expr.attrHandle;Ce.fn.extend({attr:function(e,t){return Pe(this,Ce.attr,e,t,arguments.length>1)},removeAttr:function(e){return this.each(function(){Ce.removeAttr(this,e)})}}),Ce.extend({attr:function(e,t,n){var r,i,o=e.nodeType;
...
i=t&&t.match(Le);if(i&&1===e.nodeType)for(;n=i[r++];)e.removeAttribute(n)}}),
// Hooks for boolean attributes
_t={set:function(e,t,n){
// Remove boolean attributes when set to false
return t===!1?Ce.removeAttr(e,n):e.setAttribute(n,n),n}},Ce.each(Ce.expr.match.bool.source.match(/\w+/g),function(e,t){var n=Dt[t]||Ce.find.attr;Dt[t]=function(e,t,r){var i,o,a=t.toLowerCase();
// Avoid an infinite loop by temporarily removing this function from the getter
return r||(o=Dt[a],Dt[a]=i,i=null!=n(e,t,r)?a:null,Dt[a]=o),i}});var At=/^(?:input|select|textarea|button)$/i,Nt=/^(?:a|area)$/i;Ce.fn.extend({prop:function(e,t){return Pe(this,Ce.prop,e,t,arguments.length>1)},removeProp:function(e){return this.each(function(){delete this[Ce.propFix[e]||e]})}}),Ce.extend({prop:function(e,t,n){var r,i,o=e.nodeType;
...
var t=Ce.find.attr(e,"tabindex");return t?parseInt(t,10):At.test(e.nodeName)||Nt.test(e.nodeName)&&e.href?0:-1}}},propFix:{"for":"htmlFor","class":"className"}}),
// Support: IE <=11 only
...
be.optSelected||(Ce.propHooks.selected={get:function(e){/* eslint no-unused-expressions: "off" */
...
s=J(r),i!==s&&n.setAttribute("class",s)}return this},removeClass:function(e){var t,n,r,i,o,a,s,u=0;if(we(e))return this.each(function(t){Ce(this).removeClass(e.call(this,t,Z(this)))});if(!arguments.length)return this.attr("class","");if(t=ee(e),t.length)for(;n=this[u++];)if(i=Z(n),
// This expression is here for better compressibility (see addClass)
r=1===n.nodeType&&" "+J(i)+" "){for(a=0;o=t[a++];)
// Remove *all* instances
for(;r.indexOf(" "+o+" ")>-1;)r=r.replace(" "+o+" "," ");
// Only assign if different to avoid unneeded rendering.
s=J(r),i!==s&&n.setAttribute("class",s)}return this},toggleClass:function(e,t){var n=typeof e,r="string"===n||Array.isArray(e);return"boolean"==typeof t&&r?t?this.addClass(e):this.removeClass(e):we(e)?this.each(function(n){Ce(this).toggleClass(e.call(this,n,Z(this),t),t)}):this.each(function(){var t,i,o,a;if(r)for(
// Toggle individual class names
i=0,o=Ce(this),a=ee(e);t=a[i++];)
// Check each className given, space separated list
o.hasClass(t)?o.removeClass(t):o.addClass(t);else void 0!==e&&"boolean"!==n||(t=Z(this),t&&
// Store className if set
We.set(this,"__className__",t),
// If the element has a class name or if we're passed `false`,
// then remove the whole classname (if there was one, the above saved it).
// Otherwise bring back whatever was previously saved (if anything),
// falling back to the empty string if nothing was stored.
this.setAttribute&&this.setAttribute("class",t||e===!1?"":We.get(this,"__className__")||""))})},hasClass:function(e){var t,n,r=0;for(t=" "+e+" ";n=this[r++];)if(1===n.nodeType&&(" "+J(Z(n))+" ").indexOf(t)>-1)return!0;return!1}});var qt=/\r/g;Ce.fn.extend({val:function(e){var t,n,r,i=this[0];{if(arguments.length)return r=we(e),this.each(function(n){var i;1===this.nodeType&&(i=r?e.call(this,n,Ce(this).val()):e,
...
return null!=t?t:J(Ce.text(e))}},select:{get:function(e){var t,n,r,i=e.options,a=e.selectedIndex,s="select-one"===e.type,u=s?null:[],c=s?a+1:i.length;
...
u.push(t)}return u},set:function(e,t){for(var n,r,i=e.options,o=Ce.makeArray(t),a=i.length;a--;)r=i[a],/* eslint-disable no-cond-assign */
...
be.focusin="onfocusin"in e;var Mt=/^(?:focusinfocus|focusoutblur)$/,Ot=function(e){e.stopPropagation()};Ce.extend(Ce.event,{trigger:function(t,n,r,i){var o,a,s,u,c,l,f,d,p=[r||ue],h=me.call(t,"type")?t.type:t,g=me.call(t,"namespace")?t.namespace.split("."):[];
// Don't do events on text and comment nodes
if(a=d=s=r=r||ue,3!==r.nodeType&&8!==r.nodeType&&!Mt.test(h+Ce.event.triggered)&&(h.indexOf(".")>-1&&(
...
if(!i&&!f.noBubble&&!xe(r)){for(u=f.delegateType||h,Mt.test(u+h)||(a=a.parentNode);a;a=a.parentNode)p.push(a),s=a;
...
// jQuery handler
l=(We.get(a,"events")||{})[t.type]&&We.get(a,"handle"),l&&l.apply(a,n),
// Native handler
l=c&&a[c],l&&l.apply&&Ge(a)&&(t.result=l.apply(a,n),t.result===!1&&t.preventDefault());
// If nobody prevented the default action, do it now
// Call a native DOM method on the target with the same name as the event.
// Don't do default actions on window, that's where global variables be (#6170)
// Don't re-trigger an onFOO event when we call its FOO() method
// Prevent re-triggering of the same event, since we already bubbled it above
return t.type=h,i||t.isDefaultPrevented()||f._default&&f._default.apply(p.pop(),n)!==!1||!Ge(r)||c&&we(r[h])&&!xe(r)&&(s=r[c],s&&(r[c]=null),Ce.event.triggered=h,t.isPropagationStopped()&&d.addEventListener(h,Ot),r[h](),t.isPropagationStopped()&&d.removeEventListener(h,Ot),Ce.event.triggered=void 0,s&&(r[c]=s)),t.result}},
...
var n=function(e){Ce.event.simulate(t,e.target,Ce.event.fix(e))};Ce.event.special[t]={setup:function(){var r=this.ownerDocument||this,i=We.access(r,t);i||r.addEventListener(e,n,!0),We.access(r,t,(i||0)+1)},teardown:function(){var r=this.ownerDocument||this,i=We.access(r,t)-1;i?We.access(r,t,i):(r.removeEventListener(e,n,!0),We.remove(r,t))}}});var Rt=e.location,Lt=Date.now(),Ht=/\?/;
// Cross-browser xml parsing
Ce.parseXML=function(t){var n;if(!t||"string"!=typeof t)return null;
// Support: IE 9 - 11 only
// IE throws on parseFromString with invalid input.
try{n=(new e.DOMParser).parseFromString(t,"text/xml")}catch(r){n=void 0}return n&&!n.getElementsByTagName("parsererror").length||Ce.error("Invalid XML: "+t),n};var It=/\[\]$/,Pt=/\r?\n/g,Bt=/^(?:submit|button|image|reset|file)$/i,Ft=/^(?:input|select|textarea|keygen)/i;
// Serialize an array of form elements or a set of
// key/values into a query string
Ce.param=function(e,t){var n,r=[],i=function(e,t){
// If value is a function, invoke it and use its return value
var n=we(t)?t():t;r[r.length]=encodeURIComponent(e)+"="+encodeURIComponent(null==n?"":n)};if(null==e)return"";
...
return this.name&&!Ce(this).is(":disabled")&&Ft.test(this.nodeName)&&!Bt.test(e)&&(this.checked||!nt.test(e))}).map(function(e,t){var n=Ce(this).val();return null==n?null:Array.isArray(n)?Ce.map(n,function(e){return{name:t.name,value:e.replace(Pt,"\r\n")}}):{name:t.name,value:n.replace(Pt,"\r\n")}}).get()}});var Gt=/%20/g,Wt=/#.*$/,$t=/([?&])_=[^&]*/,zt=/^(.*?):[ \t]*([^\r\n]*)$/gm,
// #7653, #8125, #8152: local protocol detection
Vt=/^(?:about|app|app-storage|.+-extension|file|res|widget):$/,Ut=/^(?:GET|HEAD)$/,Xt=/^\/\//,/* Prefilters
...
Jt=ue.createElement("a");Jt.href=Rt.href,Ce.extend({
// Counter for holding the number of active queries
active:0,
// Last-Modified header cache for next request
lastModified:{},etag:{},ajaxSettings:{url:Rt.href,type:"GET",isLocal:Vt.test(Rt.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",/*
		timeout: 0,
		data: null,
		dataType: null,
		username: null,
...
return t?ie(ie(e,Ce.ajaxSettings),t):ie(Ce.ajaxSettings,e)},ajaxPrefilter:ne(Yt),ajaxTransport:ne(Kt),
// Main method
ajax:function(t,n){
...
h.ifModified&&(x=T.getResponseHeader("Last-Modified"),x&&(Ce.lastModified[o]=x),x=T.getResponseHeader("etag"),x&&(Ce.etag[o]=x)),
// if no content
...
getResponseHeader:function(e){var t;if(l){if(!s)for(s={};t=zt.exec(a);)s[t[1].toLowerCase()+" "]=(s[t[1].toLowerCase()+" "]||[]).concat(t[2]);t=s[e.toLowerCase()+" "]}return null==t?null:t.join(", ")},
// Raw string
...
h.url=((t||h.url||Rt.href)+"").replace(Xt,Rt.protocol+"//"),
// Alias method option to type as per ticket #12004
h.type=n.method||n.type||h.method||h.type,
// Extract dataTypes list
h.dataTypes=(h.dataType||"*").toLowerCase().match(Le)||[""],null==h.crossDomain){c=ue.createElement("a");
...
c.href=c.href,h.crossDomain=Jt.protocol+"//"+Jt.host!=c.protocol+"//"+c.host}catch(C){
...
h.data&&h.processData&&"string"!=typeof h.data&&(h.data=Ce.param(h.data,h.traditional)),
// Apply prefilters
re(Yt,h,n,T),l)return T;
...
h.hasContent?h.data&&h.processData&&0===(h.contentType||"").indexOf("application/x-www-form-urlencoded")&&(h.data=h.data.replace(Gt,"+")):(
...
h.cache===!1&&(o=o.replace($t,"$1"),p=(Ht.test(o)?"&":"?")+"_="+Lt++ +p),
// Put hash and anti-cache on the URL that will be requested (gh-1732)
h.url=o+p),
// Set the If-Modified-Since and/or If-None-Match header, if in ifModified mode.
h.ifModified&&(Ce.lastModified[o]&&T.setRequestHeader("If-Modified-Since",Ce.lastModified[o]),Ce.etag[o]&&T.setRequestHeader("If-None-Match",Ce.etag[o])),
...
r(-1,C)}}else r(-1,"No Transport");return T},getJSON:function(e,t,n){return Ce.get(e,t,n,"json")},getScript:function(e,t){return Ce.get(e,void 0,t,"script")}}),Ce.each(["get","post"],function(e,t){Ce[t]=function(e,n,r,i){
// The url can be an options object (which then must have .url)
// Shift arguments if data argument was omitted
return we(n)&&(i=i||r,r=n,n=void 0),Ce.ajax(Ce.extend({url:e,type:t,dataType:i,data:n,success:r},Ce.isPlainObject(e)&&e))}}),Ce._evalUrl=function(e,t){return Ce.ajax({url:e,
// Make this explicit, since user can override this through ajaxSetup (#11264)
type:"GET",dataType:"script",cache:!0,async:!1,global:!1,
// Only evaluate the response if it is successful (gh-4126)
// dataFilter is not invoked for failure responses, so using it instead
// of the default converter is kludgy but it works.
converters:{"text script":function(){}},dataFilter:function(e){Ce.globalEval(e,t)}})},Ce.fn.extend({wrapAll:function(e){var t;
// The elements to wrap the target around
return this[0]&&(we(e)&&(e=e.call(this[0])),t=Ce(e,this[0].ownerDocument).eq(0).clone(!0),this[0].parentNode&&t.insertBefore(this[0]),t.map(function(){for(var e=this;e.firstElementChild;)e=e.firstElementChild;return e}).append(this)),this},wrapInner:function(e){return we(e)?this.each(function(t){Ce(this).wrapInner(e.call(this,t))}):this.each(function(){var t=Ce(this),n=t.contents();n.length?n.wrapAll(e):t.append(e)})},wrap:function(e){var t=we(e);return this.each(function(n){Ce(this).wrapAll(t?e.call(this,n):e)})},unwrap:function(e){return this.parent(e).not("body").each(function(){Ce(this).replaceWith(this.childNodes)}),this}}),Ce.expr.pseudos.hidden=function(e){return!Ce.expr.pseudos.visible(e)},Ce.expr.pseudos.visible=function(e){return!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)},Ce.ajaxSettings.xhr=function(){try{return new e.XMLHttpRequest}catch(t){}};var Zt={
// File protocol always yields status code 0, assume 200
0:200,
// Support: IE <=9 only
// #1450: sometimes IE returns 1223 when it should be 204
1223:204},en=Ce.ajaxSettings.xhr();be.cors=!!en&&"withCredentials"in en,be.ajax=en=!!en,Ce.ajaxTransport(function(t){var n,r;
// Cross domain only allowed if supported through XMLHttpRequest
if(be.cors||en&&!t.crossDomain)return{send:function(i,o){var a,s=t.xhr();
...
s.status,s.statusText):o(Zt[s.status]||s.status,s.statusText,
// Support: IE <=9 only
...
if(e.crossDomain||e.scriptAttrs){var t,n;return{send:function(r,i){t=Ce("<script>").attr(e.scriptAttrs||{}).prop({charset:e.scriptCharset,src:e.url}).on("load error",n=function(e){t.remove(),n=null,e&&i("error"===e.type?404:200,e.type)}),
// Use native DOM manipulation to avoid our domManip AJAX trickery
ue.head.appendChild(t[0])},abort:function(){n&&n()}}}});var tn=[],nn=/(=)\?(?=&|$)|\?\?/;
// Default jsonp settings
Ce.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=tn.pop()||Ce.expando+"_"+Lt++;return this[e]=!0,e}}),
// Detect, normalize options and install callbacks for jsonp requests
Ce.ajaxPrefilter("json jsonp",function(t,n,r){var i,o,a,s=t.jsonp!==!1&&(nn.test(t.url)?"url":"string"==typeof t.data&&0===(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&nn.test(t.data)&&"data");
...
return i=t.jsonpCallback=we(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,s?t[s]=t[s].replace(nn,"$1"+i):t.jsonp!==!1&&(t.url+=(Ht.test(t.url)?"&":"?")+t.jsonp+"="+i),t.converters["script json"]=function(){return a||Ce.error(i+" was not called"),a[0]},t.dataTypes[0]="json",o=e[i],e[i]=function(){a=arguments},r.always(function(){
...
a&&we(o)&&o(a[0]),a=o=void 0}),"script"}),
// Support: Safari 8 only
// In Safari 8 documents created via document.implementation.createHTMLDocument
// collapse sibling forms: the second one becomes a child of the first one.
// Because of that, this security measure has to be disabled in Safari 8.
// https://bugs.webkit.org/show_bug.cgi?id=137337
be.createHTMLDocument=function(){var e=ue.implementation.createHTMLDocument("").body;return e.innerHTML="<form></form><form></form>",2===e.childNodes.length}(),
...
// Single tag
return t||(be.createHTMLDocument?(t=ue.implementation.createHTMLDocument(""),r=t.createElement("base"),r.href=ue.location.href,t.head.appendChild(r)):t=ue),i=Ae.exec(e),o=!n&&[],i?[t.createElement(i[1])]:(i=T([e],t,o),o&&o.length&&Ce(o).remove(),Ce.merge([],i.childNodes))},/**
 * Load a url into a page
 */
Ce.fn.load=function(e,t,n){var r,i,o,a=this,s=e.indexOf(" ");
// If it's a function
// We assume that it's the callback
// If we have elements to modify, make the request
return s>-1&&(r=J(e.slice(s)),e=e.slice(0,s)),we(t)?(n=t,t=void 0):t&&"object"==typeof t&&(i="POST"),a.length>0&&Ce.ajax({url:e,
...
Ce.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(e,t){Ce.fn[t]=function(e){return this.on(t,e)}}),Ce.expr.pseudos.animated=function(e){return Ce.grep(Ce.timers,function(t){return e===t.elem}).length},Ce.offset={setOffset:function(e,t,n){var r,i,o,a,s,u,c,l=Ce.css(e,"position"),f=Ce(e),d={};
// Set position first, in-case top/left are set even on static elem
"static"===l&&(e.style.position="relative"),s=f.offset(),o=Ce.css(e,"top"),u=Ce.css(e,"left"),c=("absolute"===l||"fixed"===l)&&(o+u).indexOf("auto")>-1,
// Need to be able to calculate position if either
// top or left is auto and position is either absolute or fixed
c?(r=f.position(),a=r.top,i=r.left):(a=parseFloat(o)||0,i=parseFloat(u)||0),we(t)&&(
// Use jQuery.extend here to allow modification of coordinates argument (gh-1848)
t=t.call(e,n,Ce.extend({},s))),null!=t.top&&(d.top=t.top-s.top+a),null!=t.left&&(d.left=t.left-s.left+i),"using"in t?t.using.call(e,d):f.css(d)}},Ce.fn.extend({
...
offsetParent:function(){return this.map(function(){for(var e=this.offsetParent;e&&"static"===Ce.css(e,"position");)e=e.offsetParent;return e||Ke})}}),
// Create scrollLeft and scrollTop methods
Ce.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(e,t){var n="pageYOffset"===t;Ce.fn[e]=function(r){return Pe(this,function(e,r,i){
...
Ce.each(["top","left"],function(e,t){Ce.cssHooks[t]=I(be.pixelPosition,function(e,n){if(n)
// If curCSS returns percentage, fallback to offset
return n=H(e,t),ht.test(n)?Ce(e).position()[t]+"px":n})}),
...
Ce.fn[r]=function(i,o){var a=arguments.length&&(n||"boolean"!=typeof i),s=n||(i===!0||o===!0?"margin":"border");return Pe(this,function(t,n,i){var o;
// Get document width or height
// Get width or height on the element, requesting but not forcing parseFloat
// Set width or height on the element
return xe(t)?0===r.indexOf("outer")?t["inner"+e]:t.document.documentElement["client"+e]:9===t.nodeType?(o=t.documentElement,Math.max(t.body["scroll"+e],o["scroll"+e],t.body["offset"+e],o["offset"+e],o["client"+e])):void 0===i?Ce.css(t,n,s):Ce.style(t,n,i,s)},t,a?i:void 0,a)}})}),Ce.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "),function(e,t){
...
return r=le.call(arguments,2),i=function(){return e.apply(t||this,r.concat(le.call(arguments)))},i.guid=e.guid=e.guid||Ce.guid++,i},Ce.holdReady=function(e){e?Ce.readyWait++:Ce.ready(!0)},Ce.isArray=Array.isArray,Ce.parseJSON=JSON.parse,Ce.nodeName=o,Ce.isFunction=we,Ce.isWindow=xe,Ce.camelCase=h,Ce.type=r,Ce.now=Date.now,Ce.isNumeric=function(e){
...
return Ce.noConflict=function(t){return e.$===Ce&&(e.$=on),t&&e.jQuery===Ce&&(e.jQuery=rn),Ce},t||(e.jQuery=e.$=Ce),Ce})}()}),require.register("process/browser.js",function(e,n,r){n=t(n,{},"process"),function(){function e(){throw new Error("setTimeout has not been defined")}function t(){throw new Error("clearTimeout has not been defined")}function n(t){if(c===setTimeout)
...
if(a(this).attr("title").includes("\n")){a(this).attr("data-fate-armor-init",!0);var n=a(this).attr("title").split("\n")[0];a(this).attr("data-fate-armor-name",n);var r=a(this).has("._2kz8P").length+a(this).has("._3iMN1").length>0;a(this).attr("data-fate-masterwork",r);var i=a(this).attr("id").split("-")[0];a(this).attr("data-fate-serial",i)}})}function i(){a("[data-fate-armor-init=true]").each(function(e,t){var n=a(this).attr("data-fate-serial"),r=a.map(a(this).find("svg"),function(e,t){return a(e).attr("data-icon")});a(this).attr("data-fate-dim-tags",r.join(","));var i=s.contains(n);if(a(this).attr("data-fate-armor-registered",i),!i)return a(this).removeAttr("data-fate-comment"),a(this).removeAttr("data-fate-mob"),a(this).removeAttr("data-fate-res"),a(this).removeAttr("data-fate-rec"),a(this).removeAttr("data-fate-int"),a(this).removeAttr("data-fate-dis"),a(this).removeAttr("data-fate-str"),void a(this).removeAttr("data-fate-stats-total");var o=s.get(n);a(this).attr("data-fate-comment",o.comments),a(this).attr("data-fate-mob",o.mob),a(this).attr("data-fate-res",o.res),a(this).attr("data-fate-rec",o.rec),a(this).attr("data-fate-int",o["int"]),a(this).attr("data-fate-dis",o.dis),a(this).attr("data-fate-str",o.str),a(this).attr("data-fate-stats-total",o.total)})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("armorRollDatabase.js").armorRollDB,u=["Helmet","Gauntlets","Chest Armor","Leg Armor","Warlock Bond","Titan Mark","Hunter Cloak"],c=u.map(function(e){return"[title$='"+e+"']"}).join(",");o.subscribe(n,"fate.refresh",function(){r(),i()})}),require.register("armorRoll.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}const i=t("fateBus.js");i.registerModule(n);var o=function a(e,t,n,i,o,s,u,c,l){r(this,a),this.rollID=e,this.name=t,this.mob=parseInt(n),this.res=parseInt(i),this.rec=parseInt(o),this["int"]=parseInt(s),this.dis=parseInt(u),this.str=parseInt(c),this.total=this.mob+this.rec+this.res+this["int"]+this.dis+this.str,this.comments=l};e.ArmorRoll=o}),require.register("armorRollDataRefresher.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n);var i=t("itemDataRefresher.js");r.subscribe(n,"fate.configurationLoaded",function(e,t){new i.ItemDataRefresher("armorRoll",t.armorRollTSV)})}),require.register("armorRollDatabase.js",function(e,t,n){function r(e){return(r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function i(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(e){return!1}}function o(e,t,n){return o=i()?Reflect.construct:function(e,t,n){var r=[null];r.push.apply(r,t);var i=Function.bind.apply(e,r),o=new i;return n&&v(o,n.prototype),o},o.apply(null,arguments)}function a(e){return c(e)||u(e)||s()}function s(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function u(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function c(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t];return n}}function l(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function f(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function d(e,t,n){return t&&f(e.prototype,t),n&&f(e,n),e}function p(e,t){return!t||"object"!==r(t)&&"function"!=typeof t?h(e):t}function h(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function g(e){return(g=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function m(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&v(e,t)}function v(e,t){return(v=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}const y=t("fateBus.js");y.registerModule(n);var b=(t("logger"),t("itemDatabase.js")),w=t("armorRoll.js"),x=/*#__PURE__*/
function(e){function t(){return l(this,t),p(this,g(t).call(this,"armorRoll"))}return m(t,e),d(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],o(w.ArmorRoll,a(e)))}}]),t}(b.ItemDatabase);e.armorRollDB=new x}),require.register("beautification.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n);var i=t("jquery");r.subscribe(n,"fate.init",function(){GM_addStyle(GM_getResourceText("fateOfAllFoolsCSS"))}),r.subscribe(n,"fate.refresh",function(){
...
document.getSelection().addRange(n))}const o=t("fateBus.js");o.registerModule(n);var a=t("logger.js"),s=jQuery=t("jquery");t("jquery-toast-plugin");var u,c;s("body").mousemove(function(e){
...
t("beautification.js"),// Update weapon comments from our database
t("commentDecorator.js"),// Show higher/lower dupes
t("dupeIndicator.js"),// Retrieve and publish data for all item types
...
function(){function e(t,n,i){r(this,e),this.name=t,this.keep=n.toLowerCase(),this.comments=i}return o(e,[{key:"keepStatus",get:function(){switch(this.keep){case"y":return s.YES;case"n":return s.NO;default:return s.UNKNOWN}}}]),e}();e.Shader=u,e.Keep=s}),require.register("shaderDataRefresher.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n);var i=t("itemDataRefresher.js");r.subscribe(n,"fate.configurationLoaded",function(e,t){new i.ItemDataRefresher("shader",t.shaderDataTSV)})}),require.register("shaderDatabase.js",function(e,t,n){function r(e){return(r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function a(e,t,n){return t&&o(e.prototype,t),n&&o(e,n),e}function s(e,t){return!t||"object"!==r(t)&&"function"!=typeof t?u(e):t}function u(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function c(e){return(c=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function l(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&f(e,t)}function f(e,t){return(f=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}const d=t("fateBus.js");d.registerModule(n);var p=(t("logger"),t("itemDatabase.js")),h=t("shader.js"),g=/*#__PURE__*/
function(e){function t(){return i(this,t),s(this,c(t).call(this,"shader"))}return l(t,e),a(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],new h.Shader(e[0],e[1],e[2]))}}]),t}(p.ItemDatabase);e.shaderDB=new g}),require.register("shaderDecorator.js",function(e,t,n){function r(){c("[title$=Shader]").not("[data-fate-shader-name]").each(function(e,t){c(this).attr("data-fate-shader-name",c(this).attr("title").split("\n")[0])})}function i(){c("[data-fate-shader-name]").each(function(e,t){var n=c(this).attr("data-fate-shader-name");c(this).attr("data-fate-shader-registered",f.contains(n))})}function o(){c('[data-fate-shader-registered="true"]').each(function(e,t){var n=f.get(c(this).attr("data-fate-shader-name"));switch(n.keepStatus){case l.Keep.YES:c(this).attr("data-fate-shader-keep",!0);break;case l.Keep.NO:c(this).attr("data-fate-shader-keep",!1);break;case l.Keep.UNKNOWN:c(this).attr("data-fate-shader-keep","unknown")}})}function a(){c('[data-fate-shader-registered="true"]').each(function(e,t){var n=f.get(c(this).attr("data-fate-shader-name"));c(this).attr("data-fate-comment",n.comments)})}/*
...
*/
function s(){c("[data-fate-shader-name]").each(function(e,t){c(this).has(".item-stat").length>0||c(this).append(c('<div class="item-stat"><div class="primary-stat">1</div></div>'))})}const u=t("fateBus.js");u.registerModule(n);var c=t("jquery"),l=t("shader.js"),f=t("shaderDatabase.js").shaderDB;u.subscribe(n,"fate.refresh",function(){r(),i(),o(),a(),s()})}),require.register("weaponDecorator.js",function(e,t,n){function r(){a(l).not("[data-fate-weapon-name]").each(function(e,t){
// We need to exclude trying to treat the weapon detail popup as something to be decorated
if(a(this).attr("title").includes("\n")){var n=a(this).attr("title").split("\n")[0];a(this).attr("data-fate-weapon-name",n);// Is it an exotic or legendary masterwork?
var r=a(this).has("._2kz8P").length+a(this).has("._3iMN1").length>0;a(this).attr("data-fate-masterwork",r);var i=a(this).attr("id").split("-")[0];a(this).attr("data-fate-serial",i)}})}function i(){a("[data-fate-weapon-name]").each(function(e,t){var n=a(this).attr("data-fate-serial"),r=a.map(a(this).find("svg"),function(e,t){return a(e).attr("data-icon")});a(this).attr("data-fate-dim-tags",r.join(","));var i=s.contains(n);if(a(this).attr("data-fate-weapon-registered",i),!i)return a(this).removeAttr("data-fate-comment"),a(this).removeAttr("data-fate-weapon-junk"),a(this).removeAttr("data-fate-weapon-pve"),void a(this).removeAttr("data-fate-weapon-pvp");var o=s.get(n);a(this).attr("data-fate-comment",o.comments),a(this).attr("data-fate-weapon-junk",o.pveUtility===u.NO&&o.pvpUtility===u.NO),a(this).attr("data-fate-weapon-pve",o.pveUtility===u.YES),a(this).attr("data-fate-weapon-pvp",o.pvpUtility===u.YES)})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("weaponRollDatabase.js").weaponRollDB,u=t("weaponRollAssessment.js").Utility,c=["Auto Rifle","Combat Bow","Fusion Rifle","Grenade Launcher","Hand Cannon","Machine Gun","Pulse Rifle","Rocket Launcher","Scout Rifle","Shotgun","Sidearm","Sniper Rifle","Submachine Gun","Sword","Trace Rifle"],l=c.map(function(e){return"[title$='"+e+"']"}).join(",");o.subscribe(n,"fate.refresh",function(){r(),i()})}),require.register("weaponRollAssessment.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function o(e,t,n){return t&&i(e.prototype,t),n&&i(e,n),e}const a=t("fateBus.js");a.registerModule(n);var s={NO:"n",YES:"y",UNKNOWN:"?"},u=/*#__PURE__*/
function(){function e(t,n,i,o,a){r(this,e),this.rollID=t,this.name=n,this.pve=i.toLowerCase(),this.pvp=o.toLowerCase(),this.comments=a}return o(e,[{key:"pveUtility",get:function(){return e.mapToStatus(this.pve)}},{key:"pvpUtility",get:function(){return e.mapToStatus(this.pvp)}}],[{key:"mapToStatus",value:function(e){switch(e){case"y":return s.YES;case"n":return s.NO;default:return s.UNKNOWN}}}]),e}();e.WeaponRollAssessment=u,e.Utility=s}),require.register("weaponRollDataRefresher.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n);var i=t("itemDataRefresher.js");r.subscribe(n,"fate.configurationLoaded",function(e,t){new i.ItemDataRefresher("weaponRoll",t.rollDataTSV)})}),require.register("weaponRollDatabase.js",function(e,t,n){function r(e){return(r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function a(e,t,n){return t&&o(e.prototype,t),n&&o(e,n),e}function s(e,t){return!t||"object"!==r(t)&&"function"!=typeof t?u(e):t}function u(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function c(e){return(c=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function l(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&f(e,t)}function f(e,t){return(f=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}const d=t("fateBus.js");d.registerModule(n);var p=(t("logger"),t("itemDatabase.js")),h=t("weaponRollAssessment.js"),g=/*#__PURE__*/
function(e){function t(){return i(this,t),s(this,c(t).call(this,"weaponRoll"))}return l(t,e),a(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],new h.WeaponRollAssessment(e[0],e[1],e[2],e[3],e[4]))}}]),t}(p.ItemDatabase);e.weaponRollDB=new g}),require.alias("blueimp-md5/js/md5.js","blueimp-md5"),require.alias("jquery/dist/jquery.js","jquery"),require.alias("jquery-toast-plugin/dist/jquery.toast.min.js","jquery-toast-plugin"),require.alias("process/browser.js","process"),require.alias("pubsub-js/src/pubsub.js","pubsub-js"),e=require("process"),require.register("___globals___",function(e,t,n){})}(),require("___globals___"),GM_configStruct.prototype={
