...
function(e){function t(){return i(this,t),s(this,c(t).call(this,"armorRoll"))}return l(t,e),a(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],new h.ArmorRoll(e[0],e[1],e[2],e[3],e[4],e[5]))}}]),t}(p.ItemDatabase);e.armorRollDB=new g}),require.register("beautification.js",function(e,t,n){const r=t("fateBus.js");r.registerModule(n);var i=t("jquery");r.subscribe(n,"fate.init",function(){GM_addStyle(GM_getResourceText("fateOfAllFoolsCSS"))}),// Remove the subclass icons
r.subscribe(n,"fate.refresh",function(){
// AFAIK this is a serial number that shouldn't change between versions...?
i(".bucket-3284755031").parents(".store-row").attr("style","display:none")}),// Remove the "Weapons" title bar
...
function(e){function t(){return i(this,t),s(this,c(t).call(this,"shader"))}return l(t,e),a(t,[{key:"createItemFromData",value:function(e){this.itemMap.set(e[0],new h.Shader(e[0],e[1],e[2]))}}]),t}(p.ItemDatabase);e.shaderDB=new g}),require.register("shaderDecorator.js",function(e,t,n){function r(){u("[title$=Shader]").not("[data-fate-shader-name]").each(function(e,t){u(this).attr("data-fate-shader-name",u(this).attr("title").split("\n")[0])})}function i(){u("[data-fate-shader-name]").each(function(e,t){var n=u(this).attr("data-fate-shader-name");u(this).attr("data-fate-shader-registered",l.contains(n))})}function o(){u('[data-fate-shader-registered="true"]').each(function(e,t){var n=l.get(u(this).attr("data-fate-shader-name"));switch(n.keepStatus){case c.Keep.YES:u(this).attr("data-fate-shader-keep",!0);break;case c.Keep.NO:u(this).attr("data-fate-shader-keep",!1);break;case c.Keep.UNKNOWN:u(this).attr("data-fate-shader-keep","unknown")}})}function a(){u('[data-fate-shader-registered="true"]').each(function(e,t){var n=l.get(u(this).attr("data-fate-shader-name"));u(this).attr("data-fate-comment",n.comments)})}const s=t("fateBus.js");s.registerModule(n);var u=t("jquery"),c=t("shader.js"),l=t("shaderDatabase.js").shaderDB;s.subscribe(n,"fate.refresh",function(){r(),i(),o(),a()})}),require.register("weaponDecorator.js",function(e,t,n){function r(){a(l).not("[data-fate-weapon-name]").each(function(e,t){
// We need to exclude trying to treat the weapon detail popup as something to be decorated
if(a(this).attr("title").includes("\n")){var n=a(this).attr("title").split("\n")[0];a(this).attr("data-fate-weapon-name",n);var r=a(this).is(".masterwork");a(this).attr("data-fate-masterwork",r);var i=a(this).attr("id").split("-")[0];a(this).attr("data-fate-serial",i)}})}function i(){a("[data-fate-weapon-name]").each(function(e,t){var n=a(this).attr("data-fate-serial"),r=a.map(a(this).find("svg"),function(e,t){return a(e).attr("data-icon")});a(this).attr("data-fate-dim-tags",r.join(","));var i=s.contains(n);if(a(this).attr("data-fate-weapon-registered",i),!i)return a(this).removeAttr("data-fate-weapon-junk"),a(this).removeAttr("data-fate-weapon-pve"),void a(this).removeAttr("data-fate-weapon-pvp");var o=s.get(n);a(this).attr("data-fate-comment",o.comments),a(this).attr("data-fate-weapon-junk",o.pveUtility===u.NO&&o.pvpUtility===u.NO),a(this).attr("data-fate-weapon-pve",o.pveUtility===u.YES),a(this).attr("data-fate-weapon-pvp",o.pvpUtility===u.YES)})}const o=t("fateBus.js");o.registerModule(n);var a=t("jquery"),s=t("weaponRollDatabase.js").weaponRollDB,u=t("weaponRollAssessment.js").Utility,c=["Auto Rifle","Combat Bow","Fusion Rifle","Grenade Launcher","Hand Cannon","Machine Gun","Pulse Rifle","Rocker Launcher","Scout Rifle","Shotgun","Sidearm","Sniper Rifle","Submachine Gun","Sword"],l=c.map(function(e){return"[title$='"+e+"']"}).join(",");o.subscribe(n,"fate.refresh",function(){r(),i()})}),require.register("weaponRollAssessment.js",function(e,t,n){function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function o(e,t,n){return t&&i(e.prototype,t),n&&i(e,n),e}const a=t("fateBus.js");a.registerModule(n);var s={NO:"n",YES:"y",UNKNOWN:"?"},u=/*#__PURE__*/
